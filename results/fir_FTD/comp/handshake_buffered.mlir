module {
  handshake.func @fir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: !handshake.control<>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["di", "idx", "di_start", "idx_start", "start"], cfg.edges = "[0,1][1,1,2,cmpi0]", resNames = ["out0", "di_end", "idx_end", "end"]} {
    ...
    %6 = buffer %5#0 {handshake.bb = 0 : ui32, handshake.name = "buffer4", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %7 = extsi %6 {handshake.bb = 0 : ui32, handshake.name = "extsi5"} : <i1> to <i11>
    %8 = buffer %5#1 {handshake.bb = 0 : ui32, handshake.name = "buffer5", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %9 = extsi %8 {handshake.bb = 0 : ui32, handshake.name = "extsi0"} : <i1> to <i32>
    %10 = buffer %51#0 {handshake.bb = 1 : ui32, handshake.name = "buffer18", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult, %falseResult = cond_br %10, %48 {handshake.bb = 1 : ui32, handshake.name = "cond_br5"} : <i1>, <i11>
    ...
    %12 = buffer %0#3 {handshake.bb = 1 : ui32, handshake.name = "buffer3", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %13 = constant %12 {ftd.imerge, handshake.bb = 1 : ui32, handshake.name = "constant0", value = false} : <>, <i1>
    ...
    %16 = buffer %51#1 {handshake.bb = 1 : ui32, handshake.name = "buffer19", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    ...
    %20 = buffer %19#0 {handshake.bb = 1 : ui32, handshake.name = "buffer9", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %21 = mux %20 [%7, %trueResult] {handshake.bb = 1 : ui32, handshake.name = "mux1"} : <i1>, <i11>
    ...
    %25 = buffer %24#0 {handshake.bb = 1 : ui32, handshake.name = "buffer13", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i11>
    %26 = trunci %25 {handshake.bb = 1 : ui32, handshake.name = "trunci0"} : <i11> to <i10>
    %27 = buffer %24#2 {handshake.bb = 1 : ui32, handshake.name = "buffer15", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i11>
    %28 = extsi %27 {handshake.bb = 1 : ui32, handshake.name = "extsi6"} : <i11> to <i12>
    %29 = buffer %24#1 {handshake.bb = 1 : ui32, handshake.name = "buffer14", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i11>
    %30 = trunci %29 {handshake.bb = 1 : ui32, handshake.name = "trunci1"} : <i11> to <i10>
    ...
    %47 = buffer %46#0 {handshake.bb = 1 : ui32, handshake.name = "buffer16", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i12>
    %48 = trunci %47 {handshake.bb = 1 : ui32, handshake.name = "trunci3"} : <i12> to <i11>
    %49 = buffer %46#1 {handshake.bb = 1 : ui32, handshake.name = "buffer17", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i12>
    %50 = cmpi ult, %49, %36 {handshake.bb = 1 : ui32, handshake.name = "cmpi0"} : <i12>
