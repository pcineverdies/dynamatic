module {
  func.func @bicg(%arg0: memref<100xi32> {handshake.arg_name = "a"}, %arg1: memref<10xi32> {handshake.arg_name = "s"}, %arg2: memref<10xi32> {handshake.arg_name = "q"}, %arg3: memref<10xi32> {handshake.arg_name = "p"}, %arg4: memref<10xi32> {handshake.arg_name = "r"}) -> i32 {
    ...
    %0:2 = scf.while (%arg5 = %c0, %arg6 = %c0_i32) : (index, i32) -> (index, i32) {
      %1 = memref.load %arg2[%arg5] {handshake.deps = #handshake<deps[<"store3" (2) [[0, 0]]>]>, handshake.name = "load5"} : memref<10xi32>
      %2:2 = scf.while (%arg7 = %c0, %arg8 = %1) : (index, i32) -> (index, i32) {
        %5 = arith.muli %arg5, %c10 {handshake.name = "muli2"} : index
        %6 = arith.addi %arg7, %5 {handshake.name = "addi2"} : index
        %7 = memref.load %arg0[%6] {handshake.name = "load10"} : memref<100xi32>
        %8 = memref.load %arg1[%arg7] {handshake.deps = #handshake<deps[<"store2" (1) [[1, 9], [0, 0]]>, <"store2" (3) [[0, 0], [0, 0]]>]>, handshake.name = "load7"} : memref<10xi32>
        %9 = memref.load %arg4[%arg5] {handshake.name = "load8"} : memref<10xi32>
        %10 = arith.muli %9, %7 {handshake.name = "muli0"} : i32
        %11 = arith.addi %8, %10 {handshake.name = "addi0"} : i32
        memref.store %11, %arg1[%arg7] {handshake.deps = #handshake<deps[<"load7" (1) [[1, 9], [0, 0]]>, <"store2" (1) [[1, 9], [0, 0]]>]>, handshake.name = "store2"} : memref<10xi32>
        %12 = memref.load %arg3[%arg7] {handshake.name = "load9"} : memref<10xi32>
        ...
        %16 = arith.cmpi ult, %15, %c10 {handshake.name = "cmpi0"} : index
      ...
      memref.store %2#1, %arg2[%arg5] {handshake.name = "store3"} : memref<10xi32>
      %3 = arith.addi %arg5, %c1 {handshake.name = "addi4"} : index
      %4 = arith.cmpi ult, %3, %c10 {handshake.name = "cmpi1"} : index
