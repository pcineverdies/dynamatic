module {
  handshake.func @bicg(%arg0: memref<100xi32>, %arg1: memref<10xi32>, %arg2: memref<10xi32>, %arg3: memref<10xi32>, %arg4: memref<10xi32>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, %arg7: !handshake.control<>, %arg8: !handshake.control<>, %arg9: !handshake.control<>, %arg10: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["a", "s", "q", "p", "r", "a_start", "s_start", "q_start", "p_start", "r_start", "start"], cfg.edges = "[0,1][2,2,3,cmpi0][1,2][3,1,4,cmpi1]", resNames = ["out0", "a_end", "s_end", "q_end", "p_end", "r_end", "end"]} {
    ...
    %12 = buffer %22#1 {handshake.bb = 1 : ui32, handshake.name = "buffer16", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %13 = mux %12 [%11, %trueResult_22] {ftd.phi, handshake.bb = 1 : ui32, handshake.name = "mux1"} : <i1>, <>
    %14 = buffer %0#8 {handshake.bb = 1 : ui32, handshake.name = "buffer8", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %15 = constant %14 {ftd.imerge, handshake.bb = 1 : ui32, handshake.name = "constant11", value = false} : <>, <i1>
    %16 = buffer %0#7 {handshake.bb = 1 : ui32, handshake.name = "buffer7", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %17 = buffer %22#2 {handshake.bb = 1 : ui32, handshake.name = "buffer17", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %18 = mux %17 [%16, %trueResult_20] {ftd.phi, handshake.bb = 1 : ui32, handshake.name = "mux3"} : <i1>, <>
    %19 = buffer %146#4 {handshake.bb = 1 : ui32, handshake.name = "buffer69", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %20 = merge %15, %19 {ftd.imerge, handshake.bb = 1 : ui32, handshake.name = "merge2"} : <i1>
    ...
    %26 = buffer %22#0 {handshake.bb = 1 : ui32, handshake.name = "buffer15", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %27 = mux %26 [%10, %trueResult_26] {handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, <i5>
    ...
    %31 = buffer %30#2 {handshake.bb = 1 : ui32, handshake.name = "buffer24", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %32 = extsi %31 {handshake.bb = 1 : ui32, handshake.name = "extsi8"} : <i5> to <i6>
    %33 = buffer %30#0 {handshake.bb = 1 : ui32, handshake.name = "buffer22", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %34 = trunci %33 {handshake.bb = 1 : ui32, handshake.name = "trunci0"} : <i5> to <i4>
    %35 = buffer %30#1 {handshake.bb = 1 : ui32, handshake.name = "buffer23", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %36 = trunci %35 {handshake.bb = 1 : ui32, handshake.name = "trunci1"} : <i5> to <i4>
    ...
    %41 = buffer %123#4 {handshake.bb = 2 : ui32, handshake.name = "buffer61", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult, %falseResult = cond_br %41, %40 {handshake.bb = 2 : ui32, handshake.bufProps = #handshake<bufProps{"1": [1,inf], [0,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "cond_br5"} : <i1>, <>
    %42 = buffer %0#6 {handshake.bb = 2 : ui32, handshake.name = "buffer6", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %43 = constant %42 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "constant12", value = false} : <>, <i1>
    ...
    %46 = buffer %51#3 {handshake.bb = 2 : ui32, handshake.name = "buffer32", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %47 = mux %46 [%45, %trueResult] {ftd.phi, handshake.bb = 2 : ui32, handshake.name = "mux7"} : <i1>, <>
    %48 = buffer %123#3 {handshake.bb = 2 : ui32, handshake.name = "buffer60", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %49 = merge %43, %48 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "merge5"} : <i1>
    ...
    %57 = buffer %123#0 {handshake.bb = 2 : ui32, handshake.name = "buffer57", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_6, %falseResult_7 = cond_br %57, %120 {handshake.bb = 2 : ui32, handshake.name = "cond_br15"} : <i1>, <i5>
    sink %falseResult_7 {handshake.name = "sink0"} : <i5>
    %58 = buffer %65#3 {handshake.bb = 2 : ui32, handshake.name = "buffer41", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %59 = buffer %123#1 {handshake.bb = 2 : ui32, handshake.name = "buffer58", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_8, %falseResult_9 = cond_br %59, %58 {handshake.bb = 2 : ui32, handshake.name = "cond_br16"} : <i1>, <i5>
    sink %falseResult_9 {handshake.name = "sink1"} : <i5>
    %60 = buffer %30#3 {handshake.bb = 2 : ui32, handshake.name = "buffer25", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %61 = buffer %51#0 {handshake.bb = 2 : ui32, handshake.name = "buffer29", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %62 = mux %61 [%60, %trueResult_8] {handshake.bb = 2 : ui32, handshake.name = "mux4"} : <i1>, <i5>
    ...
    %66 = buffer %65#0 {handshake.bb = 2 : ui32, handshake.name = "buffer38", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %67 = trunci %66 {handshake.bb = 2 : ui32, handshake.name = "trunci2"} : <i5> to <i4>
    %68 = extsi %67 {handshake.bb = 2 : ui32, handshake.name = "extsi10"} : <i4> to <i7>
    %69 = buffer %65#2 {handshake.bb = 2 : ui32, handshake.name = "buffer40", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %70 = extsi %69 {handshake.bb = 2 : ui32, handshake.name = "extsi11"} : <i5> to <i6>
    %71 = buffer %65#1 {handshake.bb = 2 : ui32, handshake.name = "buffer39", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %72 = trunci %71 {handshake.bb = 2 : ui32, handshake.name = "trunci3"} : <i5> to <i4>
    ...
    %75 = buffer %51#1 {handshake.bb = 2 : ui32, handshake.name = "buffer30", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %76 = mux %75 [%39, %trueResult_6] {handshake.bb = 2 : ui32, handshake.name = "mux6"} : <i1>, <i5>
    ...
    %80 = buffer %79#0 {handshake.bb = 2 : ui32, handshake.name = "buffer46", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %81 = extsi %80 {handshake.bb = 2 : ui32, handshake.name = "extsi12"} : <i5> to <i7>
    %82 = buffer %79#4 {handshake.bb = 2 : ui32, handshake.name = "buffer50", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %83 = extsi %82 {handshake.bb = 2 : ui32, handshake.name = "extsi13"} : <i5> to <i6>
    %84 = buffer %79#1 {handshake.bb = 2 : ui32, handshake.name = "buffer47", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %85 = trunci %84 {handshake.bb = 2 : ui32, handshake.name = "trunci4"} : <i5> to <i4>
    ...
    %88 = buffer %79#3 {handshake.bb = 2 : ui32, handshake.name = "buffer49", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %89 = trunci %88 {handshake.bb = 2 : ui32, handshake.name = "trunci6"} : <i5> to <i4>
    ...
    %96 = buffer %95#0 {handshake.bb = 2 : ui32, handshake.name = "buffer51", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %97 = extui %96 {handshake.bb = 2 : ui32, handshake.name = "extui0"} : <i2> to <i6>
    %98 = buffer %95#1 {handshake.bb = 2 : ui32, handshake.name = "buffer52", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %99 = extsi %98 {handshake.bb = 2 : ui32, handshake.name = "extsi15"} : <i2> to <i6>
    ...
    %112 = buffer %108#1 {handshake.bb = 2 : ui32, handshake.name = "buffer54", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %113 = muli %112, %dataResult_19 {handshake.bb = 2 : ui32, handshake.name = "muli1"} : <i32>
    ...
    %119 = buffer %118#0 {handshake.bb = 2 : ui32, handshake.name = "buffer55", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %120 = trunci %119 {handshake.bb = 2 : ui32, handshake.name = "trunci7"} : <i6> to <i5>
    %121 = buffer %118#1 {handshake.bb = 2 : ui32, handshake.name = "buffer56", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %122 = cmpi ult, %121, %92 {handshake.bb = 2 : ui32, handshake.name = "cmpi0"} : <i6>
    %123:5 = fork [5] %122 {handshake.bb = 2 : ui32, handshake.name = "fork10"} : <i1>
    %124 = buffer %146#3 {handshake.bb = 3 : ui32, handshake.name = "buffer68", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_20, %falseResult_21 = cond_br %124, %falseResult {handshake.bb = 3 : ui32, handshake.name = "cond_br6"} : <i1>, <>
    ...
    %126 = buffer %146#2 {handshake.bb = 3 : ui32, handshake.name = "buffer67", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_22, %falseResult_23 = cond_br %126, %125 {handshake.bb = 3 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "cond_br7"} : <i1>, <>
    ...
    %130 = buffer %56#1 {handshake.bb = 3 : ui32, handshake.name = "buffer35", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %131 = buffer %146#1 {handshake.bb = 3 : ui32, handshake.name = "buffer66", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_24, %falseResult_25 = cond_br %131, %130 {handshake.bb = 3 : ui32, handshake.name = "cond_br17"} : <i1>, <i32>
    sink %trueResult_24 {handshake.name = "sink4"} : <i32>
    %132 = buffer %146#0 {handshake.bb = 3 : ui32, handshake.name = "buffer65", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_26, %falseResult_27 = cond_br %132, %143 {handshake.bb = 3 : ui32, handshake.name = "cond_br18"} : <i1>, <i5>
    ...
    %139 = buffer %56#0 {handshake.bb = 3 : ui32, handshake.name = "buffer34", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %addressResult_28, %dataResult_29 = store[%34] %139 {handshake.bb = 3 : ui32, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store1"} : <i4>, <i32>
    %140 = addi %32, %138 {handshake.bb = 3 : ui32, handshake.name = "addi4"} : <i6>
    %141:2 = fork [2] %140 {handshake.bb = 3 : ui32, handshake.name = "fork11"} : <i6>
    %142 = buffer %141#0 {handshake.bb = 3 : ui32, handshake.name = "buffer63", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %143 = trunci %142 {handshake.bb = 3 : ui32, handshake.name = "trunci8"} : <i6> to <i5>
    %144 = buffer %141#1 {handshake.bb = 3 : ui32, handshake.name = "buffer64", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %145 = cmpi ult, %144, %135 {handshake.bb = 3 : ui32, handshake.name = "cmpi1"} : <i6>
