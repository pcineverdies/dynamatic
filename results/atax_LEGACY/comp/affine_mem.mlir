module {
  func.func @atax(%arg0: memref<10x10xf32> {handshake.arg_name = "A"}, %arg1: memref<10xf32> {handshake.arg_name = "x"}, %arg2: memref<10xf32> {handshake.arg_name = "y"}, %arg3: memref<10xf32> {handshake.arg_name = "tmp"}) -> i32 {
