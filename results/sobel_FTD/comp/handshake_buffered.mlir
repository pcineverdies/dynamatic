module {
  handshake.func @sobel(%arg0: memref<256xi32>, %arg1: memref<9xi32>, %arg2: memref<9xi32>, %arg3: memref<256xi32>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, %arg7: !handshake.control<>, %arg8: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["in", "gX", "gY", "out", "in_start", "gX_start", "gY_start", "out_start", "start"], cfg.edges = "[0,1][7,9,8,cmpi4][2,3,12,cmpi3][9,11,10,cmpi6][4,5][11,12][6,4,7,cmpi9][13,1,14,cmpi11][1,2][8,9][3,4][10,11][5,5,6,cmpi8][12,2,13,cmpi10]", resNames = ["out0", "in_end", "gX_end", "gY_end", "out_end", "end"]} {
    ...
    %8 = buffer %7#0 {handshake.bb = 0 : ui32, handshake.name = "buffer10", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %9 = extsi %8 {handshake.bb = 0 : ui32, handshake.name = "extsi26"} : <i1> to <i5>
    %10 = buffer %7#1 {handshake.bb = 0 : ui32, handshake.name = "buffer11", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %11 = extsi %10 {handshake.bb = 0 : ui32, handshake.name = "extsi2"} : <i1> to <i32>
    %12 = buffer %0#9 {handshake.bb = 1 : ui32, handshake.name = "buffer9", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %13 = constant %12 {ftd.imerge, handshake.bb = 1 : ui32, handshake.name = "constant1", value = false} : <>, <i1>
    %14 = buffer %19#1 {handshake.bb = 1 : ui32, handshake.name = "buffer16", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %15 = mux %14 [%11, %trueResult_45] {ftd.phi, handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, <i32>
    %16 = buffer %344#2 {handshake.bb = 1 : ui32, handshake.name = "buffer150", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %17 = merge %13, %16 {ftd.imerge, handshake.bb = 1 : ui32, handshake.name = "merge0"} : <i1>
    ...
    %20 = buffer %19#0 {handshake.bb = 1 : ui32, handshake.name = "buffer15", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %21 = mux %20 [%9, %trueResult_47] {handshake.bb = 1 : ui32, handshake.name = "mux1"} : <i1>, <i5>
    ...
    %25 = buffer %24#0 {handshake.bb = 1 : ui32, handshake.name = "buffer19", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %26 = extsi %25 {handshake.bb = 1 : ui32, handshake.name = "extsi27"} : <i5> to <i6>
    ...
    %30 = buffer %0#8 {handshake.bb = 2 : ui32, handshake.name = "buffer8", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %31 = constant %30 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "constant3", value = false} : <>, <i1>
    %32 = buffer %329#3 {handshake.bb = 2 : ui32, handshake.name = "buffer145", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %33 = merge %31, %32 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "merge2"} : <i1>
    ...
    %36 = buffer %24#1 {handshake.bb = 2 : ui32, handshake.name = "buffer20", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %37 = buffer %35#0 {handshake.bb = 2 : ui32, handshake.name = "buffer22", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %38 = mux %37 [%36, %trueResult_41] {handshake.bb = 2 : ui32, handshake.name = "mux2"} : <i1>, <i5>
    ...
    %42 = buffer %41#0 {handshake.bb = 2 : ui32, handshake.name = "buffer27", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %43 = extsi %42 {handshake.bb = 2 : ui32, handshake.name = "extsi29"} : <i5> to <i6>
    ...
    %48 = buffer %35#1 {handshake.bb = 2 : ui32, handshake.name = "buffer23", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %49 = mux %48 [%29, %trueResult_37] {handshake.bb = 2 : ui32, handshake.name = "mux4"} : <i1>, <i5>
    ...
    %55 = buffer %52#1 {handshake.bb = 2 : ui32, handshake.name = "buffer34", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %56 = extsi %55 {handshake.bb = 2 : ui32, handshake.name = "extsi31"} : <i5> to <i6>
    ...
    %63 = buffer %62#0 {handshake.bb = 2 : ui32, handshake.name = "buffer38", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %64 = extsi %63 {handshake.bb = 2 : ui32, handshake.name = "extsi33"} : <i1> to <i5>
    %65 = buffer %52#4 {handshake.bb = 2 : ui32, handshake.name = "buffer37", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %66 = cmpi eq, %65, %64 {handshake.bb = 2 : ui32, handshake.name = "cmpi0"} : <i5>
    %67:2 = fork [2] %66 {handshake.bb = 2 : ui32, handshake.name = "fork8"} : <i1>
    %68 = buffer %52#3 {handshake.bb = 2 : ui32, handshake.name = "buffer36", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %69 = cmpi eq, %68, %59 {handshake.bb = 2 : ui32, handshake.name = "cmpi1"} : <i5>
    %70 = buffer %62#1 {handshake.bb = 2 : ui32, handshake.name = "buffer39", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %71 = buffer %67#1 {handshake.bb = 2 : ui32, handshake.name = "buffer42", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %72 = cmpi eq, %71, %70 {handshake.bb = 2 : ui32, handshake.name = "cmpi2"} : <i1>
    %73 = andi %72, %69 {handshake.bb = 2 : ui32, handshake.name = "andi0"} : <i1>
    %74 = buffer %67#0 {handshake.bb = 2 : ui32, handshake.name = "buffer41", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %75 = ori %74, %73 {handshake.bb = 2 : ui32, handshake.name = "ori0"} : <i1>
    %76 = buffer %62#2 {handshake.bb = 2 : ui32, handshake.name = "buffer40", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %77 = cmpi eq, %75, %76 {handshake.bb = 2 : ui32, handshake.name = "cmpi3"} : <i1>
    %78:3 = fork [3] %77 {handshake.bb = 2 : ui32, handshake.name = "fork9"} : <i1>
    %79 = buffer %52#2 {handshake.bb = 3 : ui32, handshake.name = "buffer35", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %80 = buffer %78#0 {handshake.bb = 3 : ui32, handshake.name = "buffer43", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult, %falseResult = cond_br %80, %79 {handshake.bb = 3 : ui32, handshake.name = "cond_br59"} : <i1>, <i5>
    ...
    %88 = buffer %0#7 {handshake.bb = 4 : ui32, handshake.name = "buffer7", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %89 = constant %88 {ftd.imerge, handshake.bb = 4 : ui32, handshake.name = "constant7", value = false} : <>, <i1>
    %90 = buffer %229#1 {handshake.bb = 4 : ui32, handshake.name = "buffer114", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %91 = merge %89, %90 {ftd.imerge, handshake.bb = 4 : ui32, handshake.name = "merge5"} : <i1>
    ...
    %94 = buffer %93#3 {handshake.bb = 4 : ui32, handshake.name = "buffer52", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %95 = mux %94 [%dataResult, %trueResult_25] {ftd.regen, handshake.bb = 4 : ui32, handshake.name = "mux5"} : <i1>, <i32>
    ...
    %99 = buffer %87#0 {handshake.bb = 4 : ui32, handshake.name = "buffer46", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    ...
    %101 = mux %100 [%99, %trueResult_21] {ftd.phi, handshake.bb = 4 : ui32, handshake.name = "mux7"} : <i1>, <i32>
    %102 = buffer %87#1 {handshake.bb = 4 : ui32, handshake.name = "buffer47", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    ...
    %104 = mux %103 [%102, %trueResult_19] {ftd.phi, handshake.bb = 4 : ui32, handshake.name = "mux8"} : <i1>, <i32>
    %105 = buffer %93#0 {handshake.bb = 4 : ui32, handshake.name = "buffer49", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %106 = mux %105 [%83, %213] {ftd.phi, handshake.bb = 4 : ui32, handshake.name = "mux9"} : <i1>, <i32>
    ...
    %114 = buffer %207#0 {handshake.bb = 5 : ui32, handshake.name = "buffer99", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_9, %falseResult_10 = cond_br %114, %204 {handshake.bb = 5 : ui32, handshake.name = "cond_br62"} : <i1>, <i2>
    sink %falseResult_10 {handshake.name = "sink1"} : <i2>
    %115 = extsi %trueResult_9 {handshake.bb = 5 : ui32, handshake.name = "extsi34"} : <i2> to <i32>
    %116 = buffer %137#4 {handshake.bb = 5 : ui32, handshake.name = "buffer82", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %117 = buffer %207#3 {handshake.bb = 5 : ui32, handshake.name = "buffer102", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_11, %falseResult_12 = cond_br %117, %116 {handshake.bb = 5 : ui32, handshake.name = "cond_br63"} : <i1>, <i32>
    sink %falseResult_12 {handshake.name = "sink2"} : <i32>
    %118 = buffer %131#2 {handshake.bb = 5 : ui32, handshake.name = "buffer75", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    ...
    %trueResult_13, %falseResult_14 = cond_br %119, %118 {handshake.bb = 5 : ui32, handshake.name = "cond_br64"} : <i1>, <i32>
    sink %falseResult_14 {handshake.name = "sink3"} : <i32>
    %120 = buffer %0#6 {handshake.bb = 5 : ui32, handshake.name = "buffer6", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %121 = constant %120 {ftd.imerge, handshake.bb = 5 : ui32, handshake.name = "constant36", value = false} : <>, <i1>
    %122 = buffer %207#5 {handshake.bb = 5 : ui32, handshake.name = "buffer104", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %123 = merge %121, %122 {ftd.imerge, handshake.bb = 5 : ui32, handshake.name = "merge10"} : <i1>
    ...
    %126 = buffer %98#1 {handshake.bb = 5 : ui32, handshake.name = "buffer56", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    ...
    %128 = mux %127 [%126, %trueResult_13] {ftd.regen, handshake.bb = 5 : ui32, handshake.name = "mux10"} : <i1>, <i32>
    ...
    %132 = buffer %109#1 {handshake.bb = 5 : ui32, handshake.name = "buffer64", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %133 = buffer %125#3 {handshake.bb = 5 : ui32, handshake.name = "buffer69", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %134 = mux %133 [%132, %trueResult_11] {ftd.regen, handshake.bb = 5 : ui32, handshake.name = "mux15"} : <i1>, <i32>
    ...
    %138 = buffer %137#0 {handshake.bb = 5 : ui32, handshake.name = "buffer78", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %139 = trunci %138 {handshake.bb = 5 : ui32, handshake.name = "trunci1"} : <i32> to <i3>
    %140 = extsi %139 {handshake.bb = 5 : ui32, handshake.name = "extsi35"} : <i3> to <i4>
    %141 = buffer %137#1 {handshake.bb = 5 : ui32, handshake.name = "buffer79", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %142 = trunci %141 {handshake.bb = 5 : ui32, handshake.name = "trunci2"} : <i32> to <i4>
    %143 = buffer %137#2 {handshake.bb = 5 : ui32, handshake.name = "buffer80", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %144 = trunci %143 {handshake.bb = 5 : ui32, handshake.name = "trunci3"} : <i32> to <i3>
    %145 = extsi %144 {handshake.bb = 5 : ui32, handshake.name = "extsi36"} : <i3> to <i4>
    %146 = buffer %137#3 {handshake.bb = 5 : ui32, handshake.name = "buffer81", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %147 = trunci %146 {handshake.bb = 5 : ui32, handshake.name = "trunci4"} : <i32> to <i4>
    ...
    %156 = buffer %125#0 {handshake.bb = 5 : ui32, handshake.name = "buffer66", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %157 = mux %156 [%111, %115] {ftd.phi, handshake.bb = 5 : ui32, handshake.name = "mux18"} : <i1>, <i32>
    ...
    %161 = buffer %160#0 {handshake.bb = 5 : ui32, handshake.name = "buffer89", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %162 = trunci %161 {handshake.bb = 5 : ui32, handshake.name = "trunci5"} : <i32> to <i4>
    %163 = buffer %160#1 {handshake.bb = 5 : ui32, handshake.name = "buffer90", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %164 = trunci %163 {handshake.bb = 5 : ui32, handshake.name = "trunci6"} : <i32> to <i4>
    ...
    %174 = buffer %173#0 {handshake.bb = 5 : ui32, handshake.name = "buffer94", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %175 = extui %174 {handshake.bb = 5 : ui32, handshake.name = "extui2"} : <i2> to <i4>
    %176 = buffer %173#1 {handshake.bb = 5 : ui32, handshake.name = "buffer95", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %177 = extui %176 {handshake.bb = 5 : ui32, handshake.name = "extui3"} : <i2> to <i4>
    %178 = buffer %173#2 {handshake.bb = 5 : ui32, handshake.name = "buffer96", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %179 = extsi %178 {handshake.bb = 5 : ui32, handshake.name = "extsi9"} : <i2> to <i32>
    ...
    %183 = buffer %167#0 {handshake.bb = 5 : ui32, handshake.name = "buffer92", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %184 = addi %182, %183 {handshake.bb = 5 : ui32, handshake.name = "addi5"} : <i4>
    ...
    %185 = buffer %131#1 {handshake.bb = 5 : ui32, handshake.name = "buffer74", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %186 = muli %185, %dataResult_16 {handshake.bb = 5 : ui32, handshake.name = "muli0"} : <i32>
    ...
    %193 = buffer %167#1 {handshake.bb = 5 : ui32, handshake.name = "buffer93", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %194 = addi %192, %193 {handshake.bb = 5 : ui32, handshake.name = "addi7"} : <i4>
    ...
    %195 = buffer %131#0 {handshake.bb = 5 : ui32, handshake.name = "buffer73", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %196 = muli %195, %dataResult_18 {handshake.bb = 5 : ui32, handshake.name = "muli1"} : <i32>
    ...
    %200 = buffer %160#2 {handshake.bb = 5 : ui32, handshake.name = "buffer91", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %201 = addi %200, %179 {handshake.bb = 5 : ui32, handshake.name = "addi9"} : <i32>
    %202:2 = fork [2] %201 {handshake.bb = 5 : ui32, handshake.name = "fork20"} : <i32>
    %203 = buffer %202#0 {handshake.bb = 5 : ui32, handshake.name = "buffer97", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %204 = trunci %203 {handshake.bb = 5 : ui32, handshake.name = "trunci7"} : <i32> to <i2>
    %205 = buffer %202#1 {handshake.bb = 5 : ui32, handshake.name = "buffer98", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %206 = cmpi ult, %205, %170 {handshake.bb = 5 : ui32, handshake.name = "cmpi8"} : <i32>
    ...
    %212 = buffer %229#0 {handshake.bb = 6 : ui32, handshake.name = "buffer113", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_23, %falseResult_24 = cond_br %212, %226 {handshake.bb = 6 : ui32, handshake.name = "cond_br67"} : <i1>, <i2>
    sink %falseResult_24 {handshake.name = "sink4"} : <i2>
    %213 = extsi %trueResult_23 {handshake.bb = 6 : ui32, handshake.name = "extsi37"} : <i2> to <i32>
    %214 = buffer %98#0 {handshake.bb = 6 : ui32, handshake.name = "buffer55", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %215 = buffer %229#4 {handshake.bb = 6 : ui32, handshake.name = "buffer117", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_25, %falseResult_26 = cond_br %215, %214 {handshake.bb = 6 : ui32, handshake.name = "cond_br68"} : <i1>, <i32>
    ...
    %222 = buffer %109#0 {handshake.bb = 6 : ui32, handshake.name = "buffer63", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %223 = addi %222, %221 {handshake.bb = 6 : ui32, handshake.name = "addi10"} : <i32>
    %224:2 = fork [2] %223 {handshake.bb = 6 : ui32, handshake.name = "fork24"} : <i32>
    %225 = buffer %224#0 {handshake.bb = 6 : ui32, handshake.name = "buffer111", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %226 = trunci %225 {handshake.bb = 6 : ui32, handshake.name = "trunci8"} : <i32> to <i2>
    %227 = buffer %224#1 {handshake.bb = 6 : ui32, handshake.name = "buffer112", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %228 = cmpi ult, %227, %218 {handshake.bb = 6 : ui32, handshake.name = "cmpi9"} : <i32>
    ...
    %236 = buffer %211#2 {handshake.bb = 7 : ui32, handshake.name = "buffer110", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %237 = buffer %235#0 {handshake.bb = 7 : ui32, handshake.name = "buffer118", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %238 = cmpi sgt, %236, %237 {handshake.bb = 7 : ui32, handshake.name = "cmpi4"} : <i32>
    ...
    %241 = buffer %235#1 {handshake.bb = 7 : ui32, handshake.name = "buffer119", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    ...
    %243 = select %242[%241, %240] {handshake.bb = 7 : ui32, handshake.name = "select1"} : <i1>, <i32>
    %244 = buffer %211#0 {handshake.bb = 8 : ui32, handshake.name = "buffer108", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %245 = buffer %239#2 {handshake.bb = 8 : ui32, handshake.name = "buffer122", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_27, %falseResult_28 = cond_br %245, %244 {handshake.bb = 8 : ui32, handshake.name = "cond_br40"} : <i1>, <i32>
    ...
    %250 = buffer %239#1 {handshake.bb = 9 : ui32, handshake.name = "buffer121", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_29, %falseResult_30 = cond_br %250, %231 {handshake.bb = 9 : ui32, handshake.name = "cond_br69"} : <i1>, <i1>
    sink %falseResult_30 {handshake.name = "sink7"} : <i1>
    %251 = buffer %239#0 {handshake.bb = 9 : ui32, handshake.name = "buffer120", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %252 = mux %251 [%249, %trueResult_29] {ftd.phi, handshake.bb = 9 : ui32, handshake.name = "mux19"} : <i1>, <i1>
    ...
    %256 = buffer %255#0 {handshake.bb = 9 : ui32, handshake.name = "buffer126", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %257 = extsi %256 {handshake.bb = 9 : ui32, handshake.name = "extsi14"} : <i1> to <i32>
    ...
    %265 = buffer %209#2 {handshake.bb = 9 : ui32, handshake.name = "buffer107", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %266 = buffer %261#0 {handshake.bb = 9 : ui32, handshake.name = "buffer128", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %267 = cmpi sgt, %265, %266 {handshake.bb = 9 : ui32, handshake.name = "cmpi6"} : <i32>
    ...
    %270 = buffer %261#1 {handshake.bb = 9 : ui32, handshake.name = "buffer129", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    ...
    %272 = select %271[%270, %269] {handshake.bb = 9 : ui32, handshake.name = "select3"} : <i1>, <i32>
    %273 = buffer %209#0 {handshake.bb = 10 : ui32, handshake.name = "buffer105", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %274 = buffer %268#2 {handshake.bb = 10 : ui32, handshake.name = "buffer132", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_31, %falseResult_32 = cond_br %274, %273 {handshake.bb = 10 : ui32, handshake.name = "cond_br44"} : <i1>, <i32>
    ...
    %282 = buffer %255#1 {handshake.bb = 11 : ui32, handshake.name = "buffer127", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %283 = buffer %268#1 {handshake.bb = 11 : ui32, handshake.name = "buffer131", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_35, %falseResult_36 = cond_br %283, %282 {handshake.bb = 11 : ui32, handshake.name = "cond_br71"} : <i1>, <i1>
    sink %falseResult_36 {handshake.name = "sink9"} : <i1>
    %284 = buffer %268#0 {handshake.bb = 11 : ui32, handshake.name = "buffer130", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %285 = mux %284 [%278, %trueResult_35] {ftd.phi, handshake.bb = 11 : ui32, handshake.name = "mux20"} : <i1>, <i1>
    ...
    %294 = buffer %329#0 {handshake.bb = 12 : ui32, handshake.name = "buffer142", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_37, %falseResult_38 = cond_br %294, %326 {handshake.bb = 12 : ui32, handshake.name = "cond_br72"} : <i1>, <i5>
    sink %falseResult_38 {handshake.name = "sink10"} : <i5>
    %295 = buffer %306#1 {handshake.bb = 12 : ui32, handshake.name = "buffer139", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    ...
    %trueResult_39, %falseResult_40 = cond_br %296, %295 {handshake.bb = 12 : ui32, handshake.name = "cond_br73"} : <i1>, <i32>
    %297 = buffer %41#1 {handshake.bb = 12 : ui32, handshake.name = "buffer28", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    ...
    %trueResult_41, %falseResult_42 = cond_br %298, %297 {handshake.bb = 12 : ui32, handshake.name = "cond_br74"} : <i1>, <i5>
    sink %falseResult_42 {handshake.name = "sink11"} : <i5>
    %299 = buffer %0#4 {handshake.bb = 12 : ui32, handshake.name = "buffer4", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %300 = constant %299 {handshake.bb = 12 : ui32, handshake.name = "constant46", value = 1 : i2} : <>, <i2>
    ...
    %316 = buffer %306#0 {handshake.bb = 12 : ui32, handshake.name = "buffer138", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %317 = trunci %316 {handshake.bb = 12 : ui32, handshake.name = "trunci0"} : <i32> to <i8>
    ...
    %325 = buffer %324#0 {handshake.bb = 12 : ui32, handshake.name = "buffer140", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %326 = trunci %325 {handshake.bb = 12 : ui32, handshake.name = "trunci9"} : <i6> to <i5>
    %327 = buffer %324#1 {handshake.bb = 12 : ui32, handshake.name = "buffer141", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %328 = cmpi ult, %327, %312 {handshake.bb = 12 : ui32, handshake.name = "cmpi10"} : <i6>
    %329:4 = fork [4] %328 {handshake.bb = 12 : ui32, handshake.name = "fork33"} : <i1>
    %330 = buffer %344#1 {handshake.bb = 13 : ui32, handshake.name = "buffer149", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_45, %falseResult_46 = cond_br %330, %falseResult_40 {handshake.bb = 13 : ui32, handshake.name = "cond_br75"} : <i1>, <i32>
    %331 = buffer %344#0 {handshake.bb = 13 : ui32, handshake.name = "buffer148", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_47, %falseResult_48 = cond_br %331, %341 {handshake.bb = 13 : ui32, handshake.name = "cond_br76"} : <i1>, <i5>
    ...
    %340 = buffer %339#0 {handshake.bb = 13 : ui32, handshake.name = "buffer146", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %341 = trunci %340 {handshake.bb = 13 : ui32, handshake.name = "trunci10"} : <i6> to <i5>
    %342 = buffer %339#1 {handshake.bb = 13 : ui32, handshake.name = "buffer147", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %343 = cmpi ult, %342, %337 {handshake.bb = 13 : ui32, handshake.name = "cmpi11"} : <i6>
