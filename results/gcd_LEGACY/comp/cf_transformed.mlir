module {
  func.func @gcd(%arg0: i32 {handshake.arg_name = "a"}, %arg1: i32 {handshake.arg_name = "b"}) -> i32 {
    ...
    cf.cond_br %5, ^bb1(%c0_i32, %arg1, %arg0 : i32, i32, i32), ^bb12(%3 : i32)
  ^bb1(%6: i32, %7: i32, %8: i32):  // 2 preds: ^bb0, ^bb2
    ...
    cf.cond_br %11, ^bb2(%6, %7, %8 : i32, i32, i32), ^bb3(%8 : i32)
  ...
  ^bb3(%18: i32):  // 2 preds: ^bb1, ^bb4
    ...
    cf.cond_br %22, ^bb4(%18 : i32), ^bb5(%7 : i32)
  ^bb4(%23: i32):  // pred: ^bb3
  ...
  ^bb5(%25: i32):  // 2 preds: ^bb3, ^bb6
    ...
    cf.cond_br %29, ^bb6(%25 : i32), ^bb7(%25, %18 : i32, i32)
  ^bb6(%30: i32):  // pred: ^bb5
  ...
  ^bb9(%43: i32):  // 2 preds: ^bb8, ^bb10
    ...
    cf.cond_br %47, ^bb10(%43 : i32), ^bb7(%39, %43 : i32, i32)
