  ...
  func.func @gcd(%arg0: i32 {handshake.arg_name = "a"}, %arg1: i32 {handshake.arg_name = "b"}) -> i32 {
    ...
    %6 = scf.if %5 -> (i32) {
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %16 = arith.subi %c0_i32, %12 {handshake.name = "subi2"} : i32
        %17 = arith.select %15, %12, %16 {handshake.name = "select2"} : i32
        %18 = scf.while (%arg4 = %17) : (i32) -> i32 {
          %19 = arith.cmpi sgt, %arg4, %c0_i32 {handshake.name = "cmpi11"} : i32
          %20 = arith.andi %arg4, %c1_i32 {handshake.name = "andi6"} : i32
          %21 = arith.cmpi eq, %20, %c0_i32 {handshake.name = "cmpi12"} : i32
          %22 = arith.andi %19, %21 {handshake.name = "andi7"} : i1
          scf.condition(%22) {handshake.name = "condition4"} %arg4 : i32
        } do {
        ^bb0(%arg4: i32):
          %19 = arith.shrsi %arg4, %c1_i32 {handshake.name = "shrsi4"} : i32
          scf.yield {handshake.name = "yield5"} %19 : i32
        } attributes {handshake.name = "while3"}
        scf.yield {handshake.name = "yield6"} %14, %18 : i32, i32
