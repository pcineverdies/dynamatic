  ...
  func.func @kernel_3mm(%arg0: memref<49xi32> {handshake.arg_name = "A"}, %arg1: memref<49xi32> {handshake.arg_name = "B"}, %arg2: memref<49xi32> {handshake.arg_name = "C"}, %arg3: memref<49xi32> {handshake.arg_name = "D"}, %arg4: memref<49xi32> {handshake.arg_name = "E"}, %arg5: memref<49xi32> {handshake.arg_name = "F"}, %arg6: memref<49xi32> {handshake.arg_name = "G"}) {
    ...
    %0 = scf.while (%arg7 = %c0) : (index) -> index {
      %3 = scf.while (%arg8 = %c0) : (index) -> index {
        %6 = arith.muli %arg7, %c7 {handshake.name = "muli3"} : index
        %7 = arith.addi %arg8, %6 {handshake.name = "addi3"} : index
        memref.store %c0_i32, %arg4[%7] {handshake.deps = #handshake<deps[<"load20" (3) [[0, 0], [0, 0]]>, <"store13" (3) [[0, 0], [0, 0]]>, <"load24" (1)>]>, handshake.name = "store12"} : memref<49xi32>
        %8 = scf.while (%arg9 = %c0) : (index) -> index {
          %11 = arith.muli %arg7, %c7 {handshake.name = "muli4"} : index
          %12 = arith.addi %arg9, %11 {handshake.name = "addi4"} : index
          %13 = memref.load %arg0[%12] {handshake.name = "load18"} : memref<49xi32>
          %14 = arith.muli %arg9, %c7 {handshake.name = "muli5"} : index
          %15 = arith.addi %arg8, %14 {handshake.name = "addi5"} : index
          %16 = memref.load %arg1[%15] {handshake.name = "load19"} : memref<49xi32>
          %17 = arith.muli %13, %16 {handshake.name = "muli0"} : i32
          %18 = arith.muli %arg7, %c7 {handshake.name = "muli6"} : index
          %19 = arith.addi %arg8, %18 {handshake.name = "addi6"} : index
          %20 = memref.load %arg4[%19] {handshake.deps = #handshake<deps[<"store13" (3) [[0, 0], [0, 0], [1, 6]]>, <"store13" (4) [[0, 0], [0, 0], [0, 0]]>]>, handshake.name = "load20"} : memref<49xi32>
          %21 = arith.addi %20, %17 {handshake.name = "addi0"} : i32
          %22 = arith.muli %arg7, %c7 {handshake.name = "muli7"} : index
          %23 = arith.addi %arg8, %22 {handshake.name = "addi7"} : index
          memref.store %21, %arg4[%23] {handshake.deps = #handshake<deps[<"load20" (3) [[0, 0], [0, 0], [1, 6]]>, <"store13" (3) [[0, 0], [0, 0], [1, 6]]>, <"load24" (1)>]>, handshake.name = "store13"} : memref<49xi32>
          %24 = arith.addi %arg9, %c1 {handshake.name = "addi18"} : index
          %25 = arith.cmpi ult, %24, %c7 {handshake.name = "cmpi0"} : index
    ...
    %1 = scf.while (%arg7 = %c0) : (index) -> index {
      %3 = scf.while (%arg8 = %c0) : (index) -> index {
        %6 = arith.muli %arg7, %c7 {handshake.name = "muli8"} : index
        %7 = arith.addi %arg8, %6 {handshake.name = "addi8"} : index
        memref.store %c0_i32, %arg5[%7] {handshake.deps = #handshake<deps[<"load23" (3) [[0, 0], [0, 0]]>, <"store15" (3) [[0, 0], [0, 0]]>, <"load25" (1)>]>, handshake.name = "store14"} : memref<49xi32>
        %8 = scf.while (%arg9 = %c0) : (index) -> index {
          %11 = arith.muli %arg7, %c7 {handshake.name = "muli9"} : index
          %12 = arith.addi %arg9, %11 {handshake.name = "addi9"} : index
          %13 = memref.load %arg2[%12] {handshake.name = "load21"} : memref<49xi32>
          %14 = arith.muli %arg9, %c7 {handshake.name = "muli10"} : index
          %15 = arith.addi %arg8, %14 {handshake.name = "addi10"} : index
          %16 = memref.load %arg3[%15] {handshake.name = "load22"} : memref<49xi32>
          %17 = arith.muli %13, %16 {handshake.name = "muli1"} : i32
          %18 = arith.muli %arg7, %c7 {handshake.name = "muli11"} : index
          %19 = arith.addi %arg8, %18 {handshake.name = "addi11"} : index
          %20 = memref.load %arg5[%19] {handshake.deps = #handshake<deps[<"store15" (3) [[0, 0], [0, 0], [1, 6]]>, <"store15" (4) [[0, 0], [0, 0], [0, 0]]>]>, handshake.name = "load23"} : memref<49xi32>
          %21 = arith.addi %20, %17 {handshake.name = "addi1"} : i32
          %22 = arith.muli %arg7, %c7 {handshake.name = "muli12"} : index
          %23 = arith.addi %arg8, %22 {handshake.name = "addi12"} : index
          memref.store %21, %arg5[%23] {handshake.deps = #handshake<deps[<"load23" (3) [[0, 0], [0, 0], [1, 6]]>, <"store15" (3) [[0, 0], [0, 0], [1, 6]]>, <"load25" (1)>]>, handshake.name = "store15"} : memref<49xi32>
          %24 = arith.addi %arg9, %c1 {handshake.name = "addi21"} : index
          %25 = arith.cmpi ult, %24, %c7 {handshake.name = "cmpi3"} : index
        ...
        %10 = arith.cmpi ult, %9, %c7 {handshake.name = "cmpi4"} : index
    ...
    %2 = scf.while (%arg7 = %c0) : (index) -> index {
      %3 = scf.while (%arg8 = %c0) : (index) -> index {
        %6 = arith.muli %arg7, %c7 {handshake.name = "muli13"} : index
        %7 = arith.addi %arg8, %6 {handshake.name = "addi13"} : index
        memref.store %c0_i32, %arg6[%7] {handshake.deps = #handshake<deps[<"load26" (3) [[0, 0], [0, 0]]>, <"store17" (3) [[0, 0], [0, 0]]>]>, handshake.name = "store16"} : memref<49xi32>
        %8 = scf.while (%arg9 = %c0) : (index) -> index {
          %11 = arith.muli %arg7, %c7 {handshake.name = "muli14"} : index
          %12 = arith.addi %arg9, %11 {handshake.name = "addi14"} : index
          %13 = memref.load %arg4[%12] {handshake.name = "load24"} : memref<49xi32>
          %14 = arith.muli %arg9, %c7 {handshake.name = "muli15"} : index
          %15 = arith.addi %arg8, %14 {handshake.name = "addi15"} : index
          %16 = memref.load %arg5[%15] {handshake.name = "load25"} : memref<49xi32>
          %17 = arith.muli %13, %16 {handshake.name = "muli2"} : i32
          %18 = arith.muli %arg7, %c7 {handshake.name = "muli16"} : index
          %19 = arith.addi %arg8, %18 {handshake.name = "addi16"} : index
          %20 = memref.load %arg6[%19] {handshake.deps = #handshake<deps[<"store17" (3) [[0, 0], [0, 0], [1, 6]]>, <"store17" (4) [[0, 0], [0, 0], [0, 0]]>]>, handshake.name = "load26"} : memref<49xi32>
          %21 = arith.addi %20, %17 {handshake.name = "addi2"} : i32
          %22 = arith.muli %arg7, %c7 {handshake.name = "muli17"} : index
          %23 = arith.addi %arg8, %22 {handshake.name = "addi17"} : index
          memref.store %21, %arg6[%23] {handshake.deps = #handshake<deps[<"load26" (3) [[0, 0], [0, 0], [1, 6]]>, <"store17" (3) [[0, 0], [0, 0], [1, 6]]>]>, handshake.name = "store17"} : memref<49xi32>
          %24 = arith.addi %arg9, %c1 {handshake.name = "addi24"} : index
          %25 = arith.cmpi ult, %24, %c7 {handshake.name = "cmpi6"} : index
        ...
        %10 = arith.cmpi ult, %9, %c7 {handshake.name = "cmpi7"} : index
      ...
      %5 = arith.cmpi ult, %4, %c7 {handshake.name = "cmpi8"} : index
