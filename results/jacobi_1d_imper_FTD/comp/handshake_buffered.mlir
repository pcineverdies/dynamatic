module {
  handshake.func @jacobi_1d_imper(%arg0: memref<50xi32>, %arg1: memref<50xi32>, %arg2: !handshake.control<>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["A", "B", "A_start", "B_start", "start"], cfg.edges = "[0,1][2,2,3,cmpi0][4,1,5,cmpi2][1,2][3,3,4,cmpi1]", resNames = ["out0", "A_end", "B_end", "end"]} {
    ...
    %14 = merge %12, %13 {ftd.imerge, handshake.bb = 1 : ui32, handshake.name = "merge3"} : <i1>
    ...
    %17 = buffer %16#0 {handshake.bb = 1 : ui32, handshake.name = "buffer12", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %18 = mux %17 [%7, %trueResult_28] {handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, <i2>
    ...
    %26 = buffer %99#5 {handshake.bb = 2 : ui32, handshake.name = "buffer48", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult, %falseResult = cond_br %26, %25 {handshake.bb = 2 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "cond_br25"} : <i1>, <>
    ...
    %28 = buffer %99#4 {handshake.bb = 2 : ui32, handshake.name = "buffer47", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_0, %falseResult_1 = cond_br %28, %27 {handshake.bb = 2 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "cond_br26"} : <i1>, <>
    sink %trueResult_0 {handshake.name = "sink1"} : <>
    %29 = buffer %43#2 {handshake.bb = 2 : ui32, handshake.name = "buffer25", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %30 = buffer %99#3 {handshake.bb = 2 : ui32, handshake.name = "buffer46", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_2, %falseResult_3 = cond_br %30, %29 {handshake.bb = 2 : ui32, handshake.name = "cond_br27"} : <i1>, <>
    sink %falseResult_3 {handshake.name = "sink2"} : <>
    %31 = buffer %0#6 {handshake.bb = 2 : ui32, handshake.name = "buffer6", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %32 = constant %31 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "constant20", value = false} : <>, <i1>
    %33 = buffer %99#2 {handshake.bb = 2 : ui32, handshake.name = "buffer45", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %34 = merge %32, %33 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "merge7"} : <i1>
    ...
    %39 = buffer %36#1 {handshake.bb = 2 : ui32, handshake.name = "buffer18", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %40 = mux %39 [%38, %trueResult_2] {ftd.regen, handshake.bb = 2 : ui32, handshake.name = "mux7"} : <i1>, <>
    ...
    %45 = buffer %44 {handshake.bb = 2 : ui32, handshake.name = "buffer24", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %46:2 = lazy_fork [2] %45 {handshake.bb = 2 : ui32, handshake.bufProps = #handshake<bufProps{"0": [1,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "lazy_fork0"} : <>
    ...
    %48 = buffer %47 {handshake.bb = 2 : ui32, handshake.name = "buffer22", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %49:2 = lazy_fork [2] %48 {handshake.bb = 2 : ui32, handshake.bufProps = #handshake<bufProps{"0": [1,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "lazy_fork1"} : <>
    %50 = buffer %77#1 {handshake.bb = 2 : ui32, handshake.name = "buffer36", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %51 = buffer %99#1 {handshake.bb = 2 : ui32, handshake.name = "buffer44", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_4, %falseResult_5 = cond_br %51, %50 {handshake.bb = 2 : ui32, handshake.name = "cond_br10"} : <i1>, <i2>
    sink %trueResult_4 {handshake.name = "sink3"} : <i2>
    %52 = extsi %falseResult_5 {handshake.bb = 2 : ui32, handshake.name = "extsi11"} : <i2> to <i7>
    %53 = buffer %99#0 {handshake.bb = 2 : ui32, handshake.name = "buffer43", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_6, %falseResult_7 = cond_br %53, %96 {handshake.bb = 2 : ui32, handshake.name = "cond_br11"} : <i1>, <i7>
    sink %falseResult_7 {handshake.name = "sink4"} : <i7>
    %54 = buffer %36#0 {handshake.bb = 2 : ui32, handshake.name = "buffer17", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %55 = mux %54 [%24, %trueResult_6] {handshake.bb = 2 : ui32, handshake.name = "mux1"} : <i1>, <i7>
    ...
    %59 = buffer %58#0 {handshake.bb = 2 : ui32, handshake.name = "buffer30", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i7>
    %60 = trunci %59 {handshake.bb = 2 : ui32, handshake.name = "trunci0"} : <i7> to <i6>
    %61 = buffer %58#1 {handshake.bb = 2 : ui32, handshake.name = "buffer31", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i7>
    %62 = trunci %61 {handshake.bb = 2 : ui32, handshake.name = "trunci1"} : <i7> to <i6>
    %63 = buffer %58#4 {handshake.bb = 2 : ui32, handshake.name = "buffer34", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i7>
    %64 = extsi %63 {handshake.bb = 2 : ui32, handshake.name = "extsi15"} : <i7> to <i8>
    ...
    %67 = buffer %58#3 {handshake.bb = 2 : ui32, handshake.name = "buffer33", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i7>
    %68 = trunci %67 {handshake.bb = 2 : ui32, handshake.name = "trunci3"} : <i7> to <i6>
    ...
    %78 = buffer %77#0 {handshake.bb = 2 : ui32, handshake.name = "buffer35", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %79 = extsi %78 {handshake.bb = 2 : ui32, handshake.name = "extsi17"} : <i2> to <i6>
    %80 = buffer %77#2 {handshake.bb = 2 : ui32, handshake.name = "buffer37", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %81 = extsi %80 {handshake.bb = 2 : ui32, handshake.name = "extsi18"} : <i2> to <i8>
    ...
    %89 = buffer %88#1 {handshake.bb = 2 : ui32, handshake.name = "buffer40", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %90 = shli %89, %83 {handshake.bb = 2 : ui32, handshake.name = "shli0"} : <i32>
    %91 = buffer %88#0 {handshake.bb = 2 : ui32, handshake.name = "buffer39", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %92 = addi %91, %90 {handshake.bb = 2 : ui32, handshake.name = "addi7"} : <i32>
    ...
    %95 = buffer %94#0 {handshake.bb = 2 : ui32, handshake.name = "buffer41", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i8>
    %96 = trunci %95 {handshake.bb = 2 : ui32, handshake.name = "trunci5"} : <i8> to <i7>
    %97 = buffer %94#1 {handshake.bb = 2 : ui32, handshake.name = "buffer42", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i8>
    %98 = cmpi ult, %97, %74 {handshake.bb = 2 : ui32, handshake.name = "cmpi0"} : <i8>
    %99:6 = fork [6] %98 {handshake.bb = 2 : ui32, handshake.name = "fork8"} : <i1>
    %100 = buffer %121#1 {handshake.bb = 3 : ui32, handshake.name = "buffer62", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %101 = buffer %156#4 {handshake.bb = 3 : ui32, handshake.name = "buffer76", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_14, %falseResult_15 = cond_br %101, %100 {handshake.bb = 3 : ui32, handshake.name = "cond_br28"} : <i1>, <>
    sink %falseResult_15 {handshake.name = "sink5"} : <>
    %102 = buffer %116#1 {handshake.bb = 3 : ui32, handshake.name = "buffer57", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %103 = buffer %156#3 {handshake.bb = 3 : ui32, handshake.name = "buffer75", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_16, %falseResult_17 = cond_br %103, %102 {handshake.bb = 3 : ui32, handshake.name = "cond_br29"} : <i1>, <>
    ...
    %105 = buffer %156#2 {handshake.bb = 3 : ui32, handshake.name = "buffer74", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_18, %falseResult_19 = cond_br %105, %104 {handshake.bb = 3 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "cond_br30"} : <i1>, <>
    sink %trueResult_18 {handshake.name = "sink7"} : <>
    %106 = buffer %0#5 {handshake.bb = 3 : ui32, handshake.name = "buffer5", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %107 = constant %106 {ftd.imerge, handshake.bb = 3 : ui32, handshake.name = "constant24", value = false} : <>, <i1>
    %108 = buffer %156#1 {handshake.bb = 3 : ui32, handshake.name = "buffer73", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %109 = merge %107, %108 {ftd.imerge, handshake.bb = 3 : ui32, handshake.name = "merge11"} : <i1>
    ...
    %112 = buffer %111#2 {handshake.bb = 3 : ui32, handshake.name = "buffer52", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %113 = mux %112 [%falseResult_1, %trueResult_16] {ftd.regen, handshake.bb = 3 : ui32, handshake.name = "mux11"} : <i1>, <>
    ...
    %117 = buffer %111#1 {handshake.bb = 3 : ui32, handshake.name = "buffer51", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %118 = mux %117 [%falseResult, %trueResult_14] {ftd.regen, handshake.bb = 3 : ui32, handshake.name = "mux12"} : <i1>, <>
    ...
    %123 = buffer %122 {handshake.bb = 3 : ui32, handshake.name = "buffer61", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %124:2 = lazy_fork [2] %123 {handshake.bb = 3 : ui32, handshake.bufProps = #handshake<bufProps{"0": [1,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "lazy_fork2"} : <>
    ...
    %127 = buffer %126 {handshake.bb = 3 : ui32, handshake.name = "buffer56", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %128:2 = lazy_fork [2] %127 {handshake.bb = 3 : ui32, handshake.bufProps = #handshake<bufProps{"0": [1,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "lazy_fork3"} : <>
    %129 = buffer %156#0 {handshake.bb = 3 : ui32, handshake.name = "buffer72", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_20, %falseResult_21 = cond_br %129, %153 {handshake.bb = 3 : ui32, handshake.name = "cond_br12"} : <i1>, <i7>
    sink %falseResult_21 {handshake.name = "sink9"} : <i7>
    %130 = buffer %0#3 {handshake.bb = 3 : ui32, handshake.name = "buffer3", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %131 = constant %130 {handshake.bb = 3 : ui32, handshake.name = "constant16", value = 1 : i2} : <>, <i2>
    %132 = extsi %131 {handshake.bb = 3 : ui32, handshake.name = "extsi5"} : <i2> to <i32>
    %133 = buffer %111#0 {handshake.bb = 3 : ui32, handshake.name = "buffer50", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %134 = mux %133 [%52, %trueResult_20] {handshake.bb = 3 : ui32, handshake.name = "mux2"} : <i1>, <i7>
    ...
    %138 = buffer %137#2 {handshake.bb = 3 : ui32, handshake.name = "buffer69", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i7>
    %139 = extsi %138 {handshake.bb = 3 : ui32, handshake.name = "extsi19"} : <i7> to <i8>
    %140 = buffer %137#0 {handshake.bb = 3 : ui32, handshake.name = "buffer67", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i7>
    %141 = trunci %140 {handshake.bb = 3 : ui32, handshake.name = "trunci6"} : <i7> to <i6>
    %142 = buffer %137#1 {handshake.bb = 3 : ui32, handshake.name = "buffer68", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i7>
    %143 = trunci %142 {handshake.bb = 3 : ui32, handshake.name = "trunci7"} : <i7> to <i6>
    ...
    %152 = buffer %151#0 {handshake.bb = 3 : ui32, handshake.name = "buffer70", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i8>
    %153 = trunci %152 {handshake.bb = 3 : ui32, handshake.name = "trunci8"} : <i8> to <i7>
    %154 = buffer %151#1 {handshake.bb = 3 : ui32, handshake.name = "buffer71", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i8>
    %155 = cmpi ult, %154, %146 {handshake.bb = 3 : ui32, handshake.name = "cmpi1"} : <i8>
    %156:5 = fork [5] %155 {handshake.bb = 3 : ui32, handshake.name = "fork14"} : <i1>
    %157 = buffer %170#1 {handshake.bb = 4 : ui32, handshake.name = "buffer80", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_26, %falseResult_27 = cond_br %157, %falseResult_19 {handshake.bb = 4 : ui32, handshake.name = "cond_br31"} : <i1>, <>
    sink %falseResult_27 {handshake.name = "sink10"} : <>
    %158 = buffer %170#0 {handshake.bb = 4 : ui32, handshake.name = "buffer79", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_28, %falseResult_29 = cond_br %158, %167 {handshake.bb = 4 : ui32, handshake.name = "cond_br13"} : <i1>, <i2>
    ...
    %166 = buffer %165#0 {handshake.bb = 4 : ui32, handshake.name = "buffer77", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i3>
    %167 = trunci %166 {handshake.bb = 4 : ui32, handshake.name = "trunci9"} : <i3> to <i2>
    %168 = buffer %165#1 {handshake.bb = 4 : ui32, handshake.name = "buffer78", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i3>
    %169 = cmpi ult, %168, %160 {handshake.bb = 4 : ui32, handshake.name = "cmpi2"} : <i3>
    %170:3 = fork [3] %169 {handshake.bb = 4 : ui32, handshake.name = "fork16"} : <i1>
    %171 = buffer %0#2 {handshake.bb = 5 : ui32, handshake.name = "buffer2", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %172 = constant %171 {handshake.bb = 5 : ui32, handshake.name = "constant23", value = 49 : i7} : <>, <i7>
