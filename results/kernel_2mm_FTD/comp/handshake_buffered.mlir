module {
  handshake.func @kernel_2mm(%arg0: !handshake.channel<i32>, %arg1: !handshake.channel<i32>, %arg2: memref<49xi32>, %arg3: memref<49xi32>, %arg4: memref<49xi32>, %arg5: memref<49xi32>, %arg6: memref<49xi32>, %arg7: !handshake.control<>, %arg8: !handshake.control<>, %arg9: !handshake.control<>, %arg10: !handshake.control<>, %arg11: !handshake.control<>, %arg12: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["alpha", "beta", "tmp", "A", "B", "C", "D", "tmp_start", "A_start", "B_start", "C_start", "D_start", "start"], cfg.edges = "[0,1][7,8][2,3][9,7,10,cmpi4][4,2,5,cmpi1][6,7][1,2][8,8,9,cmpi3][3,3,4,cmpi0][10,6,11,cmpi5][5,1,6,cmpi2]", resNames = ["out0", "tmp_end", "A_end", "B_end", "C_end", "D_end", "end"]} {
    ...
    %11 = buffer %0#14 {handshake.bb = 1 : ui32, handshake.name = "buffer14", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %12 = constant %11 {ftd.imerge, handshake.bb = 1 : ui32, handshake.name = "constant26", value = false} : <>, <i1>
    %13 = buffer %0#13 {handshake.bb = 1 : ui32, handshake.name = "buffer13", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %14 = buffer %19#3 {handshake.bb = 1 : ui32, handshake.name = "buffer21", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %15 = mux %14 [%13, %trueResult_32] {ftd.phi, handshake.bb = 1 : ui32, handshake.name = "mux6"} : <i1>, <>
    %16 = buffer %244#4 {handshake.bb = 1 : ui32, handshake.name = "buffer122", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %17 = merge %12, %16 {ftd.imerge, handshake.bb = 1 : ui32, handshake.name = "merge1"} : <i1>
    ...
    %20 = buffer %19#2 {handshake.bb = 1 : ui32, handshake.name = "buffer20", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %21 = mux %20 [%arg0, %trueResult_40] {ftd.regen, handshake.bb = 1 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,0], [0,0], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "mux0"} : <i1>, <i32>
    ...
    %25 = buffer %0#12 {handshake.bb = 1 : ui32, handshake.name = "buffer12", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %26 = buffer %19#1 {handshake.bb = 1 : ui32, handshake.name = "buffer19", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %27 = mux %26 [%25, %trueResult_38] {ftd.regen, handshake.bb = 1 : ui32, handshake.name = "mux1"} : <i1>, <>
    ...
    %31 = buffer %19#0 {handshake.bb = 1 : ui32, handshake.name = "buffer18", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %32 = mux %31 [%10, %trueResult_36] {handshake.bb = 1 : ui32, handshake.name = "mux2"} : <i1>, <i4>
    ...
    %36 = buffer %35#0 {handshake.bb = 1 : ui32, handshake.name = "buffer32", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %37 = extsi %36 {handshake.bb = 1 : ui32, handshake.name = "extsi24"} : <i4> to <i5>
    ...
    %41 = buffer %0#11 {handshake.bb = 2 : ui32, handshake.name = "buffer11", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %42 = constant %41 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "constant29", value = false} : <>, <i1>
    ...
    %45 = buffer %50#4 {handshake.bb = 2 : ui32, handshake.name = "buffer41", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %46 = mux %45 [%44, %trueResult_22] {ftd.phi, handshake.bb = 2 : ui32, handshake.name = "mux12"} : <i1>, <>
    %47 = buffer %221#5 {handshake.bb = 2 : ui32, handshake.name = "buffer115", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %48 = merge %42, %47 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "merge5"} : <i1>
    ...
    %54 = buffer %24#1 {handshake.bb = 2 : ui32, handshake.name = "buffer25", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %55 = buffer %50#3 {handshake.bb = 2 : ui32, handshake.name = "buffer40", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %56 = mux %55 [%54, %trueResult_30] {ftd.regen, handshake.bb = 2 : ui32, handshake.name = "mux5"} : <i1>, <i32>
    ...
    %60 = buffer %35#1 {handshake.bb = 2 : ui32, handshake.name = "buffer33", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %61 = buffer %50#0 {handshake.bb = 2 : ui32, handshake.name = "buffer37", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %62 = mux %61 [%60, %trueResult_28] {handshake.bb = 2 : ui32, handshake.name = "mux7"} : <i1>, <i4>
    ...
    %66 = buffer %65#2 {handshake.bb = 2 : ui32, handshake.name = "buffer51", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %67 = extsi %66 {handshake.bb = 2 : ui32, handshake.name = "extsi26"} : <i4> to <i8>
    %68 = buffer %30#1 {handshake.bb = 2 : ui32, handshake.name = "buffer29", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %69 = buffer %50#2 {handshake.bb = 2 : ui32, handshake.name = "buffer39", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %70 = mux %69 [%68, %trueResult_26] {ftd.regen, handshake.bb = 2 : ui32, handshake.name = "mux8"} : <i1>, <>
    ...
    %74 = buffer %50#1 {handshake.bb = 2 : ui32, handshake.name = "buffer38", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %75 = mux %74 [%40, %trueResult_24] {handshake.bb = 2 : ui32, handshake.name = "mux9"} : <i1>, <i4>
    ...
    %79 = buffer %78#0 {handshake.bb = 2 : ui32, handshake.name = "buffer58", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %80 = extsi %79 {handshake.bb = 2 : ui32, handshake.name = "extsi27"} : <i4> to <i6>
    %81 = buffer %78#1 {handshake.bb = 2 : ui32, handshake.name = "buffer59", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %82 = extsi %81 {handshake.bb = 2 : ui32, handshake.name = "extsi28"} : <i4> to <i5>
    %83 = buffer %73#0 {handshake.bb = 2 : ui32, handshake.name = "buffer54", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %84 = constant %83 {handshake.bb = 2 : ui32, handshake.name = "constant3", value = false} : <>, <i1>
    ...
    %95 = buffer %110#1 {handshake.bb = 3 : ui32, handshake.name = "buffer71", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %96 = buffer %200#6 {handshake.bb = 3 : ui32, handshake.name = "buffer107", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult, %falseResult = cond_br %96, %95 {handshake.bb = 3 : ui32, handshake.name = "cond_br71"} : <i1>, <>
    ...
    %99 = buffer %0#10 {handshake.bb = 3 : ui32, handshake.name = "buffer10", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %100 = constant %99 {ftd.imerge, handshake.bb = 3 : ui32, handshake.name = "constant30", value = false} : <>, <i1>
    %101 = buffer %200#4 {handshake.bb = 3 : ui32, handshake.name = "buffer105", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %102 = merge %100, %101 {ftd.imerge, handshake.bb = 3 : ui32, handshake.name = "merge8"} : <i1>
    ...
    %112 = buffer %111 {handshake.bb = 3 : ui32, handshake.name = "buffer70", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    ...
    %114 = buffer %200#0 {handshake.bb = 3 : ui32, handshake.name = "buffer101", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_6, %falseResult_7 = cond_br %114, %197 {handshake.bb = 3 : ui32, handshake.name = "cond_br47"} : <i1>, <i4>
    sink %falseResult_7 {handshake.name = "sink2"} : <i4>
    %115 = buffer %150#1 {handshake.bb = 3 : ui32, handshake.name = "buffer88", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %116 = buffer %200#3 {handshake.bb = 3 : ui32, handshake.name = "buffer104", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_8, %falseResult_9 = cond_br %116, %115 {handshake.bb = 3 : ui32, handshake.name = "cond_br48"} : <i1>, <i32>
    sink %falseResult_9 {handshake.name = "sink3"} : <i32>
    %117 = buffer %138#3 {handshake.bb = 3 : ui32, handshake.name = "buffer84", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    ...
    %trueResult_10, %falseResult_11 = cond_br %118, %117 {handshake.bb = 3 : ui32, handshake.name = "cond_br49"} : <i1>, <i4>
    sink %falseResult_11 {handshake.name = "sink4"} : <i4>
    %119 = buffer %126#3 {handshake.bb = 3 : ui32, handshake.name = "buffer78", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %120 = buffer %200#1 {handshake.bb = 3 : ui32, handshake.name = "buffer102", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_12, %falseResult_13 = cond_br %120, %119 {handshake.bb = 3 : ui32, handshake.name = "cond_br50"} : <i1>, <i4>
    sink %falseResult_13 {handshake.name = "sink5"} : <i4>
    %121 = buffer %65#1 {handshake.bb = 3 : ui32, handshake.name = "buffer50", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %122 = buffer %104#0 {handshake.bb = 3 : ui32, handshake.name = "buffer62", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %123 = mux %122 [%121, %trueResult_12] {handshake.bb = 3 : ui32, handshake.name = "mux13"} : <i1>, <i4>
    ...
    %129 = buffer %126#1 {handshake.bb = 3 : ui32, handshake.name = "buffer76", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %130 = extsi %129 {handshake.bb = 3 : ui32, handshake.name = "extsi32"} : <i4> to <i8>
    %131 = buffer %126#2 {handshake.bb = 3 : ui32, handshake.name = "buffer77", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %132 = extsi %131 {handshake.bb = 3 : ui32, handshake.name = "extsi33"} : <i4> to <i8>
    %133 = buffer %78#2 {handshake.bb = 3 : ui32, handshake.name = "buffer60", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    ...
    %135 = mux %134 [%133, %trueResult_10] {handshake.bb = 3 : ui32, handshake.name = "mux14"} : <i1>, <i4>
    ...
    %141 = buffer %138#1 {handshake.bb = 3 : ui32, handshake.name = "buffer82", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %142 = extsi %141 {handshake.bb = 3 : ui32, handshake.name = "extsi35"} : <i4> to <i6>
    ...
    %145 = buffer %59#1 {handshake.bb = 3 : ui32, handshake.name = "buffer46", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %146 = buffer %104#3 {handshake.bb = 3 : ui32, handshake.name = "buffer65", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %147 = mux %146 [%145, %trueResult_8] {ftd.regen, handshake.bb = 3 : ui32, handshake.name = "mux15"} : <i1>, <i32>
    ...
    %151 = buffer %104#2 {handshake.bb = 3 : ui32, handshake.name = "buffer64", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %152 = mux %151 [%88, %trueResult_6] {handshake.bb = 3 : ui32, handshake.name = "mux17"} : <i1>, <i4>
    ...
    %158 = buffer %155#1 {handshake.bb = 3 : ui32, handshake.name = "buffer92", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %159 = extsi %158 {handshake.bb = 3 : ui32, handshake.name = "extsi38"} : <i4> to <i5>
    %160 = buffer %155#2 {handshake.bb = 3 : ui32, handshake.name = "buffer93", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %161 = extsi %160 {handshake.bb = 3 : ui32, handshake.name = "extsi39"} : <i4> to <i8>
    ...
    %167 = buffer %164#1 {handshake.bb = 3 : ui32, handshake.name = "buffer95", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %168 = extsi %167 {handshake.bb = 3 : ui32, handshake.name = "extsi41"} : <i4> to <i8>
    %169 = buffer %164#2 {handshake.bb = 3 : ui32, handshake.name = "buffer96", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %170 = extsi %169 {handshake.bb = 3 : ui32, handshake.name = "extsi42"} : <i4> to <i8>
    ...
    %196 = buffer %195#0 {handshake.bb = 3 : ui32, handshake.name = "buffer99", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %197 = trunci %196 {handshake.bb = 3 : ui32, handshake.name = "trunci5"} : <i5> to <i4>
    ...
    %201 = buffer %221#4 {handshake.bb = 4 : ui32, handshake.name = "buffer114", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_22, %falseResult_23 = cond_br %201, %falseResult_5 {handshake.bb = 4 : ui32, handshake.name = "cond_br73"} : <i1>, <>
    %202 = buffer %221#0 {handshake.bb = 4 : ui32, handshake.name = "buffer110", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_24, %falseResult_25 = cond_br %202, %218 {handshake.bb = 4 : ui32, handshake.name = "cond_br51"} : <i1>, <i4>
    sink %falseResult_25 {handshake.name = "sink6"} : <i4>
    %203 = buffer %73#1 {handshake.bb = 4 : ui32, handshake.name = "buffer55", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %204 = buffer %221#3 {handshake.bb = 4 : ui32, handshake.name = "buffer113", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_26, %falseResult_27 = cond_br %204, %203 {handshake.bb = 4 : ui32, handshake.name = "cond_br52"} : <i1>, <>
    sink %falseResult_27 {handshake.name = "sink7"} : <>
    %205 = buffer %65#0 {handshake.bb = 4 : ui32, handshake.name = "buffer49", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %206 = buffer %221#1 {handshake.bb = 4 : ui32, handshake.name = "buffer111", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_28, %falseResult_29 = cond_br %206, %205 {handshake.bb = 4 : ui32, handshake.name = "cond_br53"} : <i1>, <i4>
    sink %falseResult_29 {handshake.name = "sink8"} : <i4>
    %207 = buffer %59#0 {handshake.bb = 4 : ui32, handshake.name = "buffer45", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %208 = buffer %221#2 {handshake.bb = 4 : ui32, handshake.name = "buffer112", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_30, %falseResult_31 = cond_br %208, %207 {handshake.bb = 4 : ui32, handshake.name = "cond_br54"} : <i1>, <i32>
    ...
    %217 = buffer %216#0 {handshake.bb = 4 : ui32, handshake.name = "buffer108", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %218 = trunci %217 {handshake.bb = 4 : ui32, handshake.name = "trunci6"} : <i5> to <i4>
    %219 = buffer %216#1 {handshake.bb = 4 : ui32, handshake.name = "buffer109", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %220 = cmpi ult, %219, %211 {handshake.bb = 4 : ui32, handshake.name = "cmpi1"} : <i5>
    %221:6 = fork [6] %220 {handshake.bb = 4 : ui32, handshake.name = "fork20"} : <i1>
    %222 = buffer %244#3 {handshake.bb = 5 : ui32, handshake.name = "buffer121", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_32, %falseResult_33 = cond_br %222, %falseResult_23 {handshake.bb = 5 : ui32, handshake.name = "cond_br74"} : <i1>, <>
    %223 = buffer %244#5 {handshake.bb = 5 : ui32, handshake.name = "buffer123", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_34, %falseResult_35 = cond_br %223, %231 {handshake.bb = 5 : ui32, handshake.name = "cond_br55"} : <i1>, <i1>
    sink %trueResult_34 {handshake.name = "sink10"} : <i1>
    %224 = extsi %falseResult_35 {handshake.bb = 5 : ui32, handshake.name = "extsi22"} : <i1> to <i4>
    %225 = buffer %244#0 {handshake.bb = 5 : ui32, handshake.name = "buffer118", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_36, %falseResult_37 = cond_br %225, %241 {handshake.bb = 5 : ui32, handshake.name = "cond_br56"} : <i1>, <i4>
    sink %falseResult_37 {handshake.name = "sink11"} : <i4>
    %226 = buffer %30#0 {handshake.bb = 5 : ui32, handshake.name = "buffer28", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %227 = buffer %244#2 {handshake.bb = 5 : ui32, handshake.name = "buffer120", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_38, %falseResult_39 = cond_br %227, %226 {handshake.bb = 5 : ui32, handshake.name = "cond_br57"} : <i1>, <>
    sink %falseResult_39 {handshake.name = "sink12"} : <>
    %228 = buffer %24#0 {handshake.bb = 5 : ui32, handshake.name = "buffer24", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %229 = buffer %244#1 {handshake.bb = 5 : ui32, handshake.name = "buffer119", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_40, %falseResult_41 = cond_br %229, %228 {handshake.bb = 5 : ui32, handshake.name = "cond_br58"} : <i1>, <i32>
    ...
    %240 = buffer %239#0 {handshake.bb = 5 : ui32, handshake.name = "buffer116", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %241 = trunci %240 {handshake.bb = 5 : ui32, handshake.name = "trunci7"} : <i5> to <i4>
    ...
    %245 = buffer %0#9 {handshake.bb = 6 : ui32, handshake.name = "buffer9", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %246 = constant %245 {ftd.imerge, handshake.bb = 6 : ui32, handshake.name = "constant34", value = false} : <>, <i1>
    %247 = buffer %485#4 {handshake.bb = 6 : ui32, handshake.name = "buffer237", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %248 = merge %246, %247 {ftd.imerge, handshake.bb = 6 : ui32, handshake.name = "merge12"} : <i1>
    ...
    %251 = buffer %250#3 {handshake.bb = 6 : ui32, handshake.name = "buffer128", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %252 = mux %251 [%falseResult_33, %trueResult_78] {ftd.regen, handshake.bb = 6 : ui32, handshake.name = "mux22"} : <i1>, <>
    ...
    %256 = buffer %0#8 {handshake.bb = 6 : ui32, handshake.name = "buffer8", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %257 = buffer %250#2 {handshake.bb = 6 : ui32, handshake.name = "buffer127", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %258 = mux %257 [%256, %trueResult_76] {ftd.phi, handshake.bb = 6 : ui32, handshake.name = "mux28"} : <i1>, <>
    %259 = buffer %250#1 {handshake.bb = 6 : ui32, handshake.name = "buffer126", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %260 = mux %259 [%arg1, %trueResult_82] {ftd.regen, handshake.bb = 6 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,0], [0,0], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "mux18"} : <i1>, <i32>
    ...
    %264 = buffer %250#0 {handshake.bb = 6 : ui32, handshake.name = "buffer125", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %265 = mux %264 [%224, %trueResult_80] {handshake.bb = 6 : ui32, handshake.name = "mux19"} : <i1>, <i4>
    ...
    %269 = buffer %268#0 {handshake.bb = 6 : ui32, handshake.name = "buffer141", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %270 = extsi %269 {handshake.bb = 6 : ui32, handshake.name = "extsi50"} : <i4> to <i5>
    ...
    %274 = buffer %0#7 {handshake.bb = 7 : ui32, handshake.name = "buffer7", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %275 = constant %274 {ftd.imerge, handshake.bb = 7 : ui32, handshake.name = "constant38", value = false} : <>, <i1>
    %276 = buffer %466#5 {handshake.bb = 7 : ui32, handshake.name = "buffer230", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %277 = merge %275, %276 {ftd.imerge, handshake.bb = 7 : ui32, handshake.name = "merge16"} : <i1>
    ...
    %280 = buffer %255#1 {handshake.bb = 7 : ui32, handshake.name = "buffer132", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %281 = buffer %279#4 {handshake.bb = 7 : ui32, handshake.name = "buffer148", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %282 = mux %281 [%280, %trueResult_68] {ftd.regen, handshake.bb = 7 : ui32, handshake.name = "mux29"} : <i1>, <>
    ...
    %288 = buffer %279#3 {handshake.bb = 7 : ui32, handshake.name = "buffer147", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %289 = mux %288 [%287, %trueResult_66] {ftd.phi, handshake.bb = 7 : ui32, handshake.name = "mux35"} : <i1>, <>
    ...
    %293 = buffer %263#1 {handshake.bb = 7 : ui32, handshake.name = "buffer138", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %294 = buffer %279#2 {handshake.bb = 7 : ui32, handshake.name = "buffer146", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %295 = mux %294 [%293, %trueResult_74] {ftd.regen, handshake.bb = 7 : ui32, handshake.name = "mux24"} : <i1>, <i32>
    ...
    %299 = buffer %268#1 {handshake.bb = 7 : ui32, handshake.name = "buffer142", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %300 = buffer %279#0 {handshake.bb = 7 : ui32, handshake.name = "buffer144", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %301 = mux %300 [%299, %trueResult_72] {handshake.bb = 7 : ui32, handshake.name = "mux25"} : <i1>, <i4>
    ...
    %305 = buffer %304#2 {handshake.bb = 7 : ui32, handshake.name = "buffer164", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %306 = extsi %305 {handshake.bb = 7 : ui32, handshake.name = "extsi52"} : <i4> to <i8>
    %307 = buffer %304#3 {handshake.bb = 7 : ui32, handshake.name = "buffer165", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %308 = extsi %307 {handshake.bb = 7 : ui32, handshake.name = "extsi53"} : <i4> to <i8>
    %309 = buffer %279#1 {handshake.bb = 7 : ui32, handshake.name = "buffer145", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %310 = mux %309 [%273, %trueResult_70] {handshake.bb = 7 : ui32, handshake.name = "mux26"} : <i1>, <i4>
    ...
    %314 = buffer %313#0 {handshake.bb = 7 : ui32, handshake.name = "buffer168", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %315 = extsi %314 {handshake.bb = 7 : ui32, handshake.name = "extsi54"} : <i4> to <i6>
    %316 = buffer %313#1 {handshake.bb = 7 : ui32, handshake.name = "buffer169", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %317 = extsi %316 {handshake.bb = 7 : ui32, handshake.name = "extsi55"} : <i4> to <i6>
    %318 = buffer %313#2 {handshake.bb = 7 : ui32, handshake.name = "buffer170", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %319 = extsi %318 {handshake.bb = 7 : ui32, handshake.name = "extsi56"} : <i4> to <i5>
    ...
    %326 = buffer %325#0 {handshake.bb = 7 : ui32, handshake.name = "buffer172", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %327 = extsi %326 {handshake.bb = 7 : ui32, handshake.name = "extsi58"} : <i4> to <i8>
    %328 = buffer %325#1 {handshake.bb = 7 : ui32, handshake.name = "buffer173", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %329 = extsi %328 {handshake.bb = 7 : ui32, handshake.name = "extsi59"} : <i4> to <i8>
    ...
    %333 = buffer %298#1 {handshake.bb = 7 : ui32, handshake.name = "buffer159", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %334 = muli %dataResult_43, %333 {handshake.bb = 7 : ui32, handshake.name = "muli2"} : <i32>
    ...
    %338 = buffer %361#1 {handshake.bb = 8 : ui32, handshake.name = "buffer189", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %339 = buffer %445#6 {handshake.bb = 8 : ui32, handshake.name = "buffer222", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_46, %falseResult_47 = cond_br %339, %338 {handshake.bb = 8 : ui32, handshake.name = "cond_br75"} : <i1>, <>
    sink %falseResult_47 {handshake.name = "sink14"} : <>
    %340 = buffer %355#1 {handshake.bb = 8 : ui32, handshake.name = "buffer184", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %341 = buffer %445#5 {handshake.bb = 8 : ui32, handshake.name = "buffer221", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_48, %falseResult_49 = cond_br %341, %340 {handshake.bb = 8 : ui32, handshake.name = "cond_br76"} : <i1>, <>
    ...
    %343 = buffer %445#4 {handshake.bb = 8 : ui32, handshake.name = "buffer220", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_50, %falseResult_51 = cond_br %343, %342 {handshake.bb = 8 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "cond_br77"} : <i1>, <>
    sink %trueResult_50 {handshake.name = "sink16"} : <>
    %344 = buffer %0#6 {handshake.bb = 8 : ui32, handshake.name = "buffer6", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %345 = constant %344 {ftd.imerge, handshake.bb = 8 : ui32, handshake.name = "constant44", value = false} : <>, <i1>
    %346 = buffer %445#3 {handshake.bb = 8 : ui32, handshake.name = "buffer219", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %347 = merge %345, %346 {ftd.imerge, handshake.bb = 8 : ui32, handshake.name = "merge22"} : <i1>
    ...
    %351 = buffer %349#4 {handshake.bb = 8 : ui32, handshake.name = "buffer179", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %352 = mux %351 [%350, %trueResult_48] {ftd.regen, handshake.bb = 8 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "mux36"} : <i1>, <>
    ...
    %356 = buffer %285#1 {handshake.bb = 8 : ui32, handshake.name = "buffer152", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %357 = buffer %349#3 {handshake.bb = 8 : ui32, handshake.name = "buffer178", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %358 = mux %357 [%356, %trueResult_46] {ftd.regen, handshake.bb = 8 : ui32, handshake.name = "mux37"} : <i1>, <>
    ...
    %363 = buffer %362 {handshake.bb = 8 : ui32, handshake.name = "buffer188", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %364:2 = lazy_fork [2] %363 {handshake.bb = 8 : ui32, handshake.bufProps = #handshake<bufProps{"0": [1,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "lazy_fork3"} : <>
    ...
    %367 = buffer %366 {handshake.bb = 8 : ui32, handshake.name = "buffer183", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %368:2 = lazy_fork [2] %367 {handshake.bb = 8 : ui32, handshake.bufProps = #handshake<bufProps{"0": [1,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "lazy_fork4"} : <>
    %369 = buffer %445#0 {handshake.bb = 8 : ui32, handshake.name = "buffer216", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_52, %falseResult_53 = cond_br %369, %442 {handshake.bb = 8 : ui32, handshake.name = "cond_br59"} : <i1>, <i4>
    sink %falseResult_53 {handshake.name = "sink18"} : <i4>
    %370 = buffer %391#3 {handshake.bb = 8 : ui32, handshake.name = "buffer203", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %371 = buffer %445#1 {handshake.bb = 8 : ui32, handshake.name = "buffer217", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_54, %falseResult_55 = cond_br %371, %370 {handshake.bb = 8 : ui32, handshake.name = "cond_br60"} : <i1>, <i4>
    sink %falseResult_55 {handshake.name = "sink19"} : <i4>
    %372 = buffer %379#3 {handshake.bb = 8 : ui32, handshake.name = "buffer197", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %373 = buffer %445#2 {handshake.bb = 8 : ui32, handshake.name = "buffer218", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_56, %falseResult_57 = cond_br %373, %372 {handshake.bb = 8 : ui32, handshake.name = "cond_br61"} : <i1>, <i4>
    sink %falseResult_57 {handshake.name = "sink20"} : <i4>
    %374 = buffer %313#3 {handshake.bb = 8 : ui32, handshake.name = "buffer171", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %375 = buffer %349#1 {handshake.bb = 8 : ui32, handshake.name = "buffer176", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %376 = mux %375 [%374, %trueResult_56] {handshake.bb = 8 : ui32, handshake.name = "mux31"} : <i1>, <i4>
    ...
    %382 = buffer %379#1 {handshake.bb = 8 : ui32, handshake.name = "buffer195", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %383 = extsi %382 {handshake.bb = 8 : ui32, handshake.name = "extsi61"} : <i4> to <i6>
    ...
    %386 = buffer %304#1 {handshake.bb = 8 : ui32, handshake.name = "buffer163", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %387 = buffer %349#0 {handshake.bb = 8 : ui32, handshake.name = "buffer175", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %388 = mux %387 [%386, %trueResult_54] {handshake.bb = 8 : ui32, handshake.name = "mux32"} : <i1>, <i4>
    ...
    %394 = buffer %391#1 {handshake.bb = 8 : ui32, handshake.name = "buffer201", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %395 = extsi %394 {handshake.bb = 8 : ui32, handshake.name = "extsi64"} : <i4> to <i8>
    %396 = buffer %391#2 {handshake.bb = 8 : ui32, handshake.name = "buffer202", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %397 = extsi %396 {handshake.bb = 8 : ui32, handshake.name = "extsi65"} : <i4> to <i8>
    %398 = buffer %349#2 {handshake.bb = 8 : ui32, handshake.name = "buffer177", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %399 = mux %398 [%322, %trueResult_52] {handshake.bb = 8 : ui32, handshake.name = "mux33"} : <i1>, <i4>
    ...
    %405 = buffer %402#1 {handshake.bb = 8 : ui32, handshake.name = "buffer207", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %406 = extsi %405 {handshake.bb = 8 : ui32, handshake.name = "extsi67"} : <i4> to <i5>
    %407 = buffer %402#2 {handshake.bb = 8 : ui32, handshake.name = "buffer208", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %408 = extsi %407 {handshake.bb = 8 : ui32, handshake.name = "extsi68"} : <i4> to <i8>
    ...
    %414 = buffer %411#1 {handshake.bb = 8 : ui32, handshake.name = "buffer210", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %415 = extsi %414 {handshake.bb = 8 : ui32, handshake.name = "extsi70"} : <i4> to <i8>
    %416 = buffer %411#2 {handshake.bb = 8 : ui32, handshake.name = "buffer211", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %417 = extsi %416 {handshake.bb = 8 : ui32, handshake.name = "extsi71"} : <i4> to <i8>
    ...
    %420 = buffer %411#4 {handshake.bb = 8 : ui32, handshake.name = "buffer213", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %421 = extsi %420 {handshake.bb = 8 : ui32, handshake.name = "extsi73"} : <i4> to <i8>
    ...
    %441 = buffer %440#0 {handshake.bb = 8 : ui32, handshake.name = "buffer214", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %442 = trunci %441 {handshake.bb = 8 : ui32, handshake.name = "trunci14"} : <i5> to <i4>
    %443 = buffer %440#1 {handshake.bb = 8 : ui32, handshake.name = "buffer215", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %444 = cmpi ult, %443, %419 {handshake.bb = 8 : ui32, handshake.name = "cmpi3"} : <i5>
    %445:7 = fork [7] %444 {handshake.bb = 8 : ui32, handshake.name = "fork41"} : <i1>
    %446 = buffer %466#4 {handshake.bb = 9 : ui32, handshake.name = "buffer229", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_66, %falseResult_67 = cond_br %446, %falseResult_51 {handshake.bb = 9 : ui32, handshake.name = "cond_br78"} : <i1>, <>
    %447 = buffer %285#0 {handshake.bb = 9 : ui32, handshake.name = "buffer151", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %448 = buffer %466#3 {handshake.bb = 9 : ui32, handshake.name = "buffer228", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_68, %falseResult_69 = cond_br %448, %447 {handshake.bb = 9 : ui32, handshake.name = "cond_br79"} : <i1>, <>
    sink %falseResult_69 {handshake.name = "sink21"} : <>
    %449 = buffer %466#0 {handshake.bb = 9 : ui32, handshake.name = "buffer225", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_70, %falseResult_71 = cond_br %449, %463 {handshake.bb = 9 : ui32, handshake.name = "cond_br62"} : <i1>, <i4>
    sink %falseResult_71 {handshake.name = "sink22"} : <i4>
    %450 = buffer %304#0 {handshake.bb = 9 : ui32, handshake.name = "buffer162", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %451 = buffer %466#1 {handshake.bb = 9 : ui32, handshake.name = "buffer226", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_72, %falseResult_73 = cond_br %451, %450 {handshake.bb = 9 : ui32, handshake.name = "cond_br63"} : <i1>, <i4>
    sink %falseResult_73 {handshake.name = "sink23"} : <i4>
    %452 = buffer %298#0 {handshake.bb = 9 : ui32, handshake.name = "buffer158", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %453 = buffer %466#2 {handshake.bb = 9 : ui32, handshake.name = "buffer227", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_74, %falseResult_75 = cond_br %453, %452 {handshake.bb = 9 : ui32, handshake.name = "cond_br64"} : <i1>, <i32>
    ...
    %462 = buffer %461#0 {handshake.bb = 9 : ui32, handshake.name = "buffer223", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %463 = trunci %462 {handshake.bb = 9 : ui32, handshake.name = "trunci15"} : <i5> to <i4>
    %464 = buffer %461#1 {handshake.bb = 9 : ui32, handshake.name = "buffer224", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %465 = cmpi ult, %464, %456 {handshake.bb = 9 : ui32, handshake.name = "cmpi4"} : <i5>
    %466:6 = fork [6] %465 {handshake.bb = 9 : ui32, handshake.name = "fork43"} : <i1>
    %467 = buffer %485#3 {handshake.bb = 10 : ui32, handshake.name = "buffer236", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_76, %falseResult_77 = cond_br %467, %falseResult_67 {handshake.bb = 10 : ui32, handshake.name = "cond_br80"} : <i1>, <>
    %468 = buffer %255#0 {handshake.bb = 10 : ui32, handshake.name = "buffer131", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %469 = buffer %485#2 {handshake.bb = 10 : ui32, handshake.name = "buffer235", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_78, %falseResult_79 = cond_br %469, %468 {handshake.bb = 10 : ui32, handshake.name = "cond_br81"} : <i1>, <>
    sink %falseResult_79 {handshake.name = "sink25"} : <>
    %470 = buffer %485#0 {handshake.bb = 10 : ui32, handshake.name = "buffer233", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_80, %falseResult_81 = cond_br %470, %482 {handshake.bb = 10 : ui32, handshake.name = "cond_br65"} : <i1>, <i4>
    sink %falseResult_81 {handshake.name = "sink26"} : <i4>
    %471 = buffer %263#0 {handshake.bb = 10 : ui32, handshake.name = "buffer137", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %472 = buffer %485#1 {handshake.bb = 10 : ui32, handshake.name = "buffer234", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_82, %falseResult_83 = cond_br %472, %471 {handshake.bb = 10 : ui32, handshake.name = "cond_br66"} : <i1>, <i32>
    ...
    %481 = buffer %480#0 {handshake.bb = 10 : ui32, handshake.name = "buffer231", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %482 = trunci %481 {handshake.bb = 10 : ui32, handshake.name = "trunci16"} : <i5> to <i4>
    %483 = buffer %480#1 {handshake.bb = 10 : ui32, handshake.name = "buffer232", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i5>
    %484 = cmpi ult, %483, %475 {handshake.bb = 10 : ui32, handshake.name = "cmpi5"} : <i5>
    ...
    %488 = buffer %0#4 {handshake.bb = 11 : ui32, handshake.name = "buffer4", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %489 = constant %488 {handshake.bb = 11 : ui32, handshake.name = "constant49", value = 48 : i7} : <>, <i7>
    ...
    %491 = buffer %0#5 {handshake.bb = 11 : ui32, handshake.name = "buffer5", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    end {handshake.bb = 11 : ui32, handshake.name = "end0"} %dataResult_85, %7#2, %memEnd_3, %memEnd_1, %memEnd, %2#3, %491 : <i32>, <>, <>, <>, <>, <>, <>
  }
}
