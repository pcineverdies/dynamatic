module {
  handshake.func @stencil_2d(%arg0: memref<900xi32>, %arg1: memref<10xi32>, %arg2: memref<900xi32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["orig", "filter", "sol", "orig_start", "filter_start", "sol_start", "start"], cfg.edges = "[0,1][2,3][4,2,5,cmpi1][1,2][3,3,4,cmpi0][5,1,6,cmpi2]", resNames = ["out0", "orig_end", "filter_end", "sol_end", "end"]} {
    ...
    %7 = buffer %6#0 {handshake.bb = 1 : ui32, handshake.name = "buffer9", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %8 = extsi %7 {handshake.bb = 1 : ui32, handshake.name = "extsi13"} : <i1> to <i6>
    %9 = buffer %6#1 {handshake.bb = 1 : ui32, handshake.name = "buffer10", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %10 = buffer %194#3 {handshake.bb = 1 : ui32, handshake.name = "buffer103", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    ...
    %14 = buffer %0#7 {handshake.bb = 1 : ui32, handshake.name = "buffer7", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %15 = buffer %13#1 {handshake.bb = 1 : ui32, handshake.name = "buffer13", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %16 = mux %15 [%14, %trueResult_25] {ftd.regen, handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, <>
    ...
    %20 = buffer %13#0 {handshake.bb = 1 : ui32, handshake.name = "buffer12", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %21 = mux %20 [%8, %trueResult_23] {handshake.bb = 1 : ui32, handshake.name = "mux10"} : <i1>, <i6>
    ...
    %27 = buffer %24#1 {handshake.bb = 1 : ui32, handshake.name = "buffer24", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %28 = extsi %27 {handshake.bb = 1 : ui32, handshake.name = "extsi14"} : <i6> to <i7>
    %29 = buffer %19#2 {handshake.bb = 1 : ui32, handshake.name = "buffer18", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %30 = constant %29 {handshake.bb = 1 : ui32, handshake.name = "constant3", value = false} : <>, <i1>
    %31:2 = fork [2] %30 {handshake.bb = 1 : ui32, handshake.name = "fork5"} : <i1>
    %32 = buffer %31#0 {handshake.bb = 1 : ui32, handshake.name = "buffer26", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %33 = extsi %32 {handshake.bb = 1 : ui32, handshake.name = "extsi15"} : <i1> to <i3>
    %34 = buffer %31#1 {handshake.bb = 1 : ui32, handshake.name = "buffer27", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %35 = extsi %34 {handshake.bb = 1 : ui32, handshake.name = "extsi2"} : <i1> to <i32>
    %36 = buffer %0#6 {handshake.bb = 2 : ui32, handshake.name = "buffer6", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %37 = constant %36 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "constant22", value = false} : <>, <i1>
    %38 = buffer %172#4 {handshake.bb = 2 : ui32, handshake.name = "buffer97", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %39 = merge %37, %38 {ftd.imerge, handshake.bb = 2 : ui32, handshake.name = "merge11"} : <i1>
    ...
    %42 = buffer %24#2 {handshake.bb = 2 : ui32, handshake.name = "buffer25", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %43 = buffer %41#0 {handshake.bb = 2 : ui32, handshake.name = "buffer29", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %44 = mux %43 [%42, %trueResult_19] {handshake.bb = 2 : ui32, handshake.name = "mux13"} : <i1>, <i6>
    ...
    %48 = buffer %19#4 {handshake.bb = 2 : ui32, handshake.name = "buffer20", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %49 = buffer %41#3 {handshake.bb = 2 : ui32, handshake.name = "buffer32", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %50 = mux %49 [%48, %trueResult_17] {ftd.regen, handshake.bb = 2 : ui32, handshake.name = "mux17"} : <i1>, <>
    ...
    %56 = buffer %41#1 {handshake.bb = 2 : ui32, handshake.name = "buffer30", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %57 = mux %56 [%33, %trueResult_15] {handshake.bb = 2 : ui32, handshake.name = "mux19"} : <i1>, <i3>
    ...
    %61 = buffer %60#0 {handshake.bb = 2 : ui32, handshake.name = "buffer48", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i3>
    %62 = extsi %61 {handshake.bb = 2 : ui32, handshake.name = "extsi16"} : <i3> to <i4>
    %63 = buffer %53#2 {handshake.bb = 2 : ui32, handshake.name = "buffer41", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %64 = constant %63 {handshake.bb = 2 : ui32, handshake.name = "constant4", value = false} : <>, <i1>
    %65 = extsi %64 {handshake.bb = 2 : ui32, handshake.name = "extsi17"} : <i1> to <i3>
    %66 = buffer %152#0 {handshake.bb = 3 : ui32, handshake.name = "buffer83", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult, %falseResult = cond_br %66, %149 {handshake.bb = 3 : ui32, handshake.name = "cond_br41"} : <i1>, <i3>
    sink %falseResult {handshake.name = "sink0"} : <i3>
    %67 = buffer %105#3 {handshake.bb = 3 : ui32, handshake.name = "buffer71", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %68 = buffer %152#5 {handshake.bb = 3 : ui32, handshake.name = "buffer88", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_3, %falseResult_4 = cond_br %68, %67 {handshake.bb = 3 : ui32, handshake.name = "cond_br42"} : <i1>, <>
    sink %falseResult_4 {handshake.name = "sink1"} : <>
    %69 = buffer %93#3 {handshake.bb = 3 : ui32, handshake.name = "buffer65", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i3>
    %70 = buffer %152#2 {handshake.bb = 3 : ui32, handshake.name = "buffer85", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_5, %falseResult_6 = cond_br %70, %69 {handshake.bb = 3 : ui32, handshake.name = "cond_br43"} : <i1>, <i3>
    sink %falseResult_6 {handshake.name = "sink2"} : <i3>
    %71 = buffer %85#1 {handshake.bb = 3 : ui32, handshake.name = "buffer59", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %72 = buffer %152#1 {handshake.bb = 3 : ui32, handshake.name = "buffer84", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_7, %falseResult_8 = cond_br %72, %71 {handshake.bb = 3 : ui32, handshake.name = "cond_br44"} : <i1>, <i6>
    ...
    %74 = buffer %0#5 {handshake.bb = 3 : ui32, handshake.name = "buffer5", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %75 = constant %74 {ftd.imerge, handshake.bb = 3 : ui32, handshake.name = "constant31", value = false} : <>, <i1>
    %76 = buffer %152#3 {handshake.bb = 3 : ui32, handshake.name = "buffer86", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %77 = merge %75, %76 {ftd.imerge, handshake.bb = 3 : ui32, handshake.name = "merge20"} : <i1>
    ...
    %80 = buffer %47#1 {handshake.bb = 3 : ui32, handshake.name = "buffer36", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %81 = buffer %79#0 {handshake.bb = 3 : ui32, handshake.name = "buffer51", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %82 = mux %81 [%80, %trueResult_7] {handshake.bb = 3 : ui32, handshake.name = "mux21"} : <i1>, <i6>
    ...
    %88 = buffer %60#1 {handshake.bb = 3 : ui32, handshake.name = "buffer49", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i3>
    %89 = buffer %79#1 {handshake.bb = 3 : ui32, handshake.name = "buffer52", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %90 = mux %89 [%88, %trueResult_5] {handshake.bb = 3 : ui32, handshake.name = "mux23"} : <i1>, <i3>
    ...
    %96 = buffer %93#1 {handshake.bb = 3 : ui32, handshake.name = "buffer63", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i3>
    %97 = extsi %96 {handshake.bb = 3 : ui32, handshake.name = "extsi20"} : <i3> to <i9>
    ...
    %100 = buffer %53#4 {handshake.bb = 3 : ui32, handshake.name = "buffer43", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %101 = buffer %79#4 {handshake.bb = 3 : ui32, handshake.name = "buffer55", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %102 = mux %101 [%100, %trueResult_3] {ftd.regen, handshake.bb = 3 : ui32, handshake.name = "mux26"} : <i1>, <>
    ...
    %110 = buffer %79#2 {handshake.bb = 3 : ui32, handshake.name = "buffer53", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %111 = mux %110 [%65, %trueResult] {handshake.bb = 3 : ui32, handshake.name = "mux28"} : <i1>, <i3>
    ...
    %119 = buffer %114#2 {handshake.bb = 3 : ui32, handshake.name = "buffer78", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i3>
    %120 = extsi %119 {handshake.bb = 3 : ui32, handshake.name = "extsi24"} : <i3> to <i4>
    %121 = buffer %105#2 {handshake.bb = 3 : ui32, handshake.name = "buffer70", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %122 = constant %121 {handshake.bb = 3 : ui32, handshake.name = "constant5", value = 30 : i6} : <>, <i6>
    %123 = extsi %122 {handshake.bb = 3 : ui32, handshake.name = "extsi25"} : <i6> to <i9>
    %124 = buffer %105#1 {handshake.bb = 3 : ui32, handshake.name = "buffer69", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %125 = constant %124 {handshake.bb = 3 : ui32, handshake.name = "constant16", value = 3 : i3} : <>, <i3>
    %126 = extsi %125 {handshake.bb = 3 : ui32, handshake.name = "extsi26"} : <i3> to <i4>
    %127 = buffer %105#0 {handshake.bb = 3 : ui32, handshake.name = "buffer68", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %128 = constant %127 {handshake.bb = 3 : ui32, handshake.name = "constant17", value = 1 : i2} : <>, <i2>
    ...
    %132 = buffer %129#1 {handshake.bb = 3 : ui32, handshake.name = "buffer80", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i2>
    %133 = extsi %132 {handshake.bb = 3 : ui32, handshake.name = "extsi27"} : <i2> to <i4>
    ...
    %148 = buffer %147#0 {handshake.bb = 3 : ui32, handshake.name = "buffer81", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %149 = trunci %148 {handshake.bb = 3 : ui32, handshake.name = "trunci0"} : <i4> to <i3>
    %150 = buffer %147#1 {handshake.bb = 3 : ui32, handshake.name = "buffer82", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %151 = cmpi ult, %150, %126 {handshake.bb = 3 : ui32, handshake.name = "cmpi0"} : <i4>
    ...
    %155 = buffer %172#0 {handshake.bb = 4 : ui32, handshake.name = "buffer93", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_15, %falseResult_16 = cond_br %155, %169 {handshake.bb = 4 : ui32, handshake.name = "cond_br47"} : <i1>, <i3>
    sink %falseResult_16 {handshake.name = "sink4"} : <i3>
    %156 = buffer %53#3 {handshake.bb = 4 : ui32, handshake.name = "buffer42", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %157 = buffer %172#2 {handshake.bb = 4 : ui32, handshake.name = "buffer95", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_17, %falseResult_18 = cond_br %157, %156 {handshake.bb = 4 : ui32, handshake.name = "cond_br48"} : <i1>, <>
    sink %falseResult_18 {handshake.name = "sink5"} : <>
    %158 = buffer %47#0 {handshake.bb = 4 : ui32, handshake.name = "buffer35", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i6>
    %159 = buffer %172#1 {handshake.bb = 4 : ui32, handshake.name = "buffer94", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_19, %falseResult_20 = cond_br %159, %158 {handshake.bb = 4 : ui32, handshake.name = "cond_br49"} : <i1>, <i6>
    sink %falseResult_20 {handshake.name = "sink6"} : <i6>
    %160 = buffer %53#1 {handshake.bb = 4 : ui32, handshake.name = "buffer40", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %161 = constant %160 {handshake.bb = 4 : ui32, handshake.name = "constant18", value = 3 : i3} : <>, <i3>
    %162 = extsi %161 {handshake.bb = 4 : ui32, handshake.name = "extsi30"} : <i3> to <i4>
    %163 = buffer %53#0 {handshake.bb = 4 : ui32, handshake.name = "buffer39", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %164 = constant %163 {handshake.bb = 4 : ui32, handshake.name = "constant19", value = 1 : i2} : <>, <i2>
    ...
    %168 = buffer %167#0 {handshake.bb = 4 : ui32, handshake.name = "buffer91", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %169 = trunci %168 {handshake.bb = 4 : ui32, handshake.name = "trunci1"} : <i4> to <i3>
    %170 = buffer %167#1 {handshake.bb = 4 : ui32, handshake.name = "buffer92", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i4>
    %171 = cmpi ult, %170, %162 {handshake.bb = 4 : ui32, handshake.name = "cmpi1"} : <i4>
    %172:5 = fork [5] %171 {handshake.bb = 4 : ui32, handshake.name = "fork20"} : <i1>
    %173 = buffer %154#1 {handshake.bb = 5 : ui32, handshake.name = "buffer90", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %174 = buffer %194#2 {handshake.bb = 5 : ui32, handshake.name = "buffer102", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_21, %falseResult_22 = cond_br %174, %173 {handshake.bb = 5 : ui32, handshake.name = "cond_br50"} : <i1>, <i32>
    sink %trueResult_21 {handshake.name = "sink7"} : <i32>
    %175 = buffer %194#0 {handshake.bb = 5 : ui32, handshake.name = "buffer100", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_23, %falseResult_24 = cond_br %175, %191 {handshake.bb = 5 : ui32, handshake.name = "cond_br51"} : <i1>, <i6>
    sink %falseResult_24 {handshake.name = "sink8"} : <i6>
    %176 = buffer %19#3 {handshake.bb = 5 : ui32, handshake.name = "buffer19", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %177 = buffer %194#1 {handshake.bb = 5 : ui32, handshake.name = "buffer101", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i1>
    %trueResult_25, %falseResult_26 = cond_br %177, %176 {handshake.bb = 5 : ui32, handshake.name = "cond_br52"} : <i1>, <>
    sink %falseResult_26 {handshake.name = "sink9"} : <>
    %178 = buffer %0#3 {handshake.bb = 5 : ui32, handshake.name = "buffer3", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %179 = constant %178 {handshake.bb = 5 : ui32, handshake.name = "constant20", value = 1 : i2} : <>, <i2>
    ...
    %184 = buffer %19#0 {handshake.bb = 5 : ui32, handshake.name = "buffer16", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    %185 = constant %184 {handshake.bb = 5 : ui32, handshake.name = "constant23", value = 1 : i2} : <>, <i2>
    %186 = extsi %185 {handshake.bb = 5 : ui32, handshake.name = "extsi33"} : <i2> to <i7>
    %187 = buffer %154#0 {handshake.bb = 5 : ui32, handshake.name = "buffer89", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i32>
    %addressResult_27, %dataResult_28 = store[%26] %187 {handshake.bb = 5 : ui32, handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "store0"} : <i10>, <i32>
    %188 = addi %28, %186 {handshake.bb = 5 : ui32, handshake.name = "addi6"} : <i7>
    %189:2 = fork [2] %188 {handshake.bb = 5 : ui32, handshake.name = "fork21"} : <i7>
    %190 = buffer %189#0 {handshake.bb = 5 : ui32, handshake.name = "buffer98", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <i7>
    %191 = trunci %190 {handshake.bb = 5 : ui32, handshake.name = "trunci2"} : <i7> to <i6>
    ...
    %195 = buffer %0#4 {handshake.bb = 6 : ui32, handshake.name = "buffer4", hw.parameters = {NUM_SLOTS = 5 : ui32, TIMING = #handshake<timing {R: 1}>}} : <>
    end {handshake.bb = 6 : ui32, handshake.name = "end0"} %falseResult_22, %memEnd_2, %memEnd_0, %memEnd, %195 : <i32>, <>, <>, <>, <>
  }
}
